  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            ...
            <h3 align="right">
                 <a href="<?php echo base_url();?>cp/getXls/3">Get Report</a>
            </h3>
        </div>
        ...
        <div class="table-content">
       	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
                ...
                <th width="10%" align="left" scope="col">Promote to Teacher</th>
            ...
            <tr>
                ...
                <td class="<?php echo $className;?>"><?php if($valList->email_send_status > 0){?><input type="checkbox" checked="checked" disabled><?php }else{?><a href="<?php echo base_url();?>emailclass/sendEmailToStudentWithCredential/<?php echo $valList->uID;?>" class="sendEmail" id="<?php echo $valList->uID;?>">Send</a><?php }?></td>
                <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>emailclass/promoteStudentToTeacher/<?php echo $valList->uID;?>" class="sendEmail" id="<?php echo $valList->uID;?>">Promote</a></td>
