  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>View GBE Level Wise Video List</h2>
<!--            <h3 align="right">
        ...
        <div class="table-content">
			...
			?>
            <tr>
                <td class="<?php echo $className;?>">Level <?php echo $valList->level;?>->Step <?php echo $valList->step;?>-><?php if($valList->serial_field != ""):?>Serial <?php echo $valList->serial_field;?><?php else:?>Intro Section<?php endif;?></td>
                ...
                <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>cp/gbeLevelWiseVideoEdit/<?php echo $valList->id;?>">Edit </a></td>
