...
<script language="javascript" type="text/javascript" src="<?php echo base_url();?>adminJS/jquery-1.9.1.min.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo base_url();?>adminJS/additional-methods.js"></script> 
...
<div class="container">
  ...
  <div class="content-inner">
        ...
        <tr>
      <td>Image</td>
      <td><img src="<?php echo base_url(); ?>adminuploads/banner/<?php echo $rows[$key]["bannerImg"]; ?>" alt="" height="90" width="100"/>
      <input type="file" name="image" id="image" />(jpg|gif|png only supported)</td>
