...
<div class="container">
  ...
  <div class="content-inner">
    ...
    <tr>
    <td>Image</td>
    <td><input type="file" name="image" id="image" />(jpg|gif|png only supported)
    ...
    <tr>
    <td colspan="2">
      <input type="submit" name="submit" id="submit" value="save" />&nbsp;<input type="reset" name="reset" id="reset" value="reset" />&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/homelogin/user_banner">cancel</a>
