 ...
 <!-- <link rel="stylesheet" href="/resources/demos/style.css">-->
  ...
  function paymentAction(uId,acTion){
	 // alert("==="+acTion);
	 if(uId>0){
...
<tr>
  ...
  ?>
	  <tr>
		...
		<td height="38" align="center" valign="middle" id="actionId_<?php echo $withdrawDataDetail['uID']; ?>"><?php if($withdrawDataDetail['status']==0){ ?><span class="approved" onClick="paymentAction(<?php echo $withdrawDataDetail['uID']; ?>,'A');">Approve</span>&nbsp;
		<span class="reject" onClick="paymentAction(<?php echo $withdrawDataDetail['uID']; ?>,'R');">Reject</span><?php } 
