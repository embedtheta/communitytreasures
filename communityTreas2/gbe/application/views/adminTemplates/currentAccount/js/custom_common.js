...
$(document).ready(function() {
    ...
    if(formSubmitMsg != "" && (formSubmitType == "customer" || formSubmitType == "tech" ||formSubmitType == "advertise" ||formSubmitType == "country" ||formSubmitType == "paypal" || formSubmitType == "image" )){ 
        $.fancybox.open(formSubmitMsg);
        return true;
    }else if(formSubmitMsg != "" && (formSubmitType == "pUpload" || formSubmitType == "vUpload" ||formSubmitType == "fListing" || formSubmitType == "deleteUser")){
        $.fancybox.open(formSubmitMsg);
        return true;
    }
     /*menu message*/
