...
function getArticle(){
	...
	$.ajax({
         type: "POST",
         url:  "<?php echo base_url();?>admin/getArticlesList", 
         data: "tableName="+str,
         cache:false,
         success: 
              function(data){
  ...
  <div class="content-wrapper">
  	<div class="content-inner">
        ...
        <div class="table-content">
         <form id="mapProductArticles" name="mapProductArticles" method="post" action="<?php echo base_url();?>admin/mapProductArticles" enctype="multipart/form-data" class="main_form">
       	  <table width="100%">
          	<tr>
            	<td>Select Menus</td>
                <td><select multiple style="width: 200px;" name="menuName[]" id="menuName">
                     <?php  foreach( $menuList as $key=>$val){?> 
  						<option value="<?php echo $val["tableID"]."_".$val["tableName"]."_".$val["menuName"];?>"><?php echo $val["menuName"];?></option>
  					  <?php } ?>	
                    </select> 
                </td>
            </tr>
