  	...
  	<div class="content-inner">
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoCreative as $key=>$valCreative){	
			...
			?>
            <tr>
       	      <td class="<?php echo $className;?>"><?php echo $infoCreative[$key]["creativeTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoCreative[$key]["creativeImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoCreative[$key]["creativeDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editCreative/<?php echo $infoCreative[$key]["creativeID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteCreative/<?php echo $infoCreative[$key]["creativeID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
