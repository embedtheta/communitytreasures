  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            ...
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addMentorship">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoMentorship as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoMentorship[$key]["mentorTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoMentorship[$key]["mentorImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoMentorship[$key]["mentorDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editMentorship/<?php echo $infoMentorship[$key]["mentorID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteMentorship/<?php echo $infoMentorship[$key]["mentorID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
