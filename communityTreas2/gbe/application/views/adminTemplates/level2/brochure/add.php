            ...
            <div class="main_section">
            	...
            	<table width="700" height="200" border="1" align="center" class="form-table">
                    ...
                    <tr>
    					...
    					<td><input type="file" value="" name="file_name" class="brws"><?php echo form_error('file_name', '<br /><span class="form_error">', '</span>'); ?></td>
    				</tr>
    				<tr>
    					<td colspan="2"><input type="submit" name="add" value="Add" class="submit-bnt" /> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>cp/listingBrochure" class="submit-bnt">Back</a></td>
    				</tr>
  				</tbody></table>
                </form>
