  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>View List of Brochure</h2>
            <h3 align="right">
               <a href="<?php echo base_url();?>cp/addBrochure">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            <!--<div>
       	  ...
       	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
                ...
                <th width="20%" align="left" scope="col">Cover Image</th>
                <th width="20%" align="left" scope="col">File Name</th>
            ...
            <tr>
                ...
                <td class="<?php echo $className;?>"><img height="60" width="60" src="<?php echo base_url();?>adminuploads/brochureVcards/brochure/<?php echo $valList->cover_img;?>" /></td>
                <td class="<?php echo $className;?>"><?php echo $valList->file_name;?></td>
                <td class="<?php echo $className;?>"> 
                    <a href="<?php echo base_url();?>cp/editBrochure/<?php echo $valList->id;?>/<?php echo $page;?>">Edit </a> || 
                    <a onclick="return confirm('Are you sure to delete this Brochure details.');" href="<?php echo base_url();?>cp/deleteBrochure/<?php echo $valList->id;?>/<?php echo $page;?>">Delete</a>
                </td>
   	        </tr>
            <?php } 
                }else{
