  ...
  <div class="content-wrapper">
    ...
    <!--Success-->
    	...
    	<div class="main_section">
        	<form id="staticArticle" name="staticArticle" method="post" action="" enctype="multipart/form-data" class="main_form">
            <input type="hidden" name="staticArticleID" id="staticArticleID" value="<?php  echo $infoArticle[0]["id"];?>"/>			
            	<table width="600" height="200" border="1" align="center" class="form-table">
    				...
    				<tr>
    					<td colspan="2">
      						<input type="submit" name="submit" id="submit" value="save" class="submit-bnt" />&nbsp;<input type="reset" name="reset" id="reset" value="reset" class="submit-bnt" />&nbsp;&nbsp;<a href="<?php echo base_url();?>admin/viewAdvert">cancel</a>
                         </td>
    				</tr>
  				</table>
            </form>
