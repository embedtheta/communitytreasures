...
<script>
 $(document).ready(function(){
	...
	$.fancybox.open('<div class="switch mov_up"><h2>Congratulations</h2><h3>You have enough people to move up.</h3><h4>Click "Move Up" to get the licence to sell<br> the product Package of Level 2.<br> You will also make large commission too.</h4><h5>60 will Be deducted from your GBE Profits</h5><p>Terma & Condiations</p><div class="switch_extrapara"><p class="swt_img"><img width="424" height="81" style="cursor:pointer" alt="" src="<?php echo base_url();?>images/move_up.png"></p> </div></div>'); 
	<?php }?>
	$.fancybox.open('<div class="switch mov_up"><h2>Congratulations</h2><h3>You have enough people to move up.</h3><h4>Click "Move Up" to get the licence to sell<br> the product Package of Level 2.<br> You will also make large commission too.</h4><h5>60 will Be deducted from your GBE Profits</h5><p>Terma & Condiations</p><div class="switch_extrapara"><p class="swt_img"><img width="424" height="81" style="cursor:pointer" alt="" src="<?php echo base_url();?>images/move_up.png"></p> </div></div>'); 
 })
</script>
      ...
      <td>Philippines</td>
                ...
                <div class="white-space">
                  <div class="gal_se_agre">
                    <div class="agr_lft">
                      <?php echo $stepWiseVideo[1]["B"]["content"];?>
