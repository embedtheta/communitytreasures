...
<body class="gambi_whit">
  ...
  <div id="wrap">
  	<div class="bdy_lft">
    	<h2>GBE Communities</h2><!--vd3--><h3>Watch Video Sign Up<br>& Make Your Community<br>A Better Place To Live</h3>
    </div>
  	<div class="bdy_right">
         <div class="rit_txt"><p><strong>Meet People</strong><strong>Neighourhood Watch</strong><strong>Actives</strong><strong>Social Events</strong></p></div>
