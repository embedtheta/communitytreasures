...
<meta property="og:title" content="GBE | COMMUNITIES" />

<meta property="og:image" content="<?php echo base_url();?>css/signup/images/FB_AFRO_IMG.jpg" />
...
<body class="gambi_whit">
  ...
  <div id="wrap">
  	...
  	<div class="bdy_lft">
    	...
    	<h2>Put Your Items on Afrowebb</h2><!--vd3--><h3>Watch Video & Sign Up,<br>find 12 to support Local black business.<br>Raise Your income.</h3>

    </div>

  	<div class="bdy_right">

         <div class="rit_txt"><p><strong>Sell Your Products.</strong><strong>Sell Your Services </strong><strong>Market Your Talent</strong><strong>Gain Exposure</strong></p></div>
         ...
         <div class="vdos_o" id="videoBoxId">
                        ...
                        <div class="vid_dmo"><h3>Watch This Video</h3>
                            ...
                            <span id="video_on_id" name="<?php if($videoPath != ""){ echo $videoPath;}?>"><img src="<?php echo base_url(); ?>css/signup/images/vdo_wtaro.png" alt="" ></span></div></div></div>
