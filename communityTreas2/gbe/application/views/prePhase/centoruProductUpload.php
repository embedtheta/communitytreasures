        ...
        <div class="subbmitq">
        	<div class="signup_body_inr">
                ...
                <!--<h4>Sign Up & Gain Your Financial Freedom</h4>-->
               		<form action="" method="post" id="frnd" enctype="multipart/form-data" class="prod_ulod">
                      ...
                      <div class="input_section">
                         <label>Which Catergory do you want to sell your product</label>
                      ...
                      <div class="input_section">
					   ...
					   <div class="input_section">
                         <label>Is Your Product a FREE Offer</label>
                       ...
                       <div class="input_section">
                         <label>Which Currency is your product to be sold in.</label>
                       ...
                       <div class="input_section">
                         <label>What is the Cost of your product? - Just write the number</label>
                        ...
                        <div class="input_section">
                         <label>How much commission are you offering  GBE members to sell your product</label>
                        ...
                        <div class="input_section">
                         <label>Show Your Youtube video of your product </label>
                         <input type="text" name="productYoutube" id="productYoutube"  value="<?php if(isset($productYoutube)){ echo $productYoutube;}?>" />
                         </div>
						 <div class="input_section">
                         <label>Which Type Of Product is it</label>
                        <select name="typeOfProduct" id="typeOfProduct" >
                        		<option value="Digital Upload Product">Digital Upload Product </option>
                                <option value="Physical Sendable Product">Physical Sendable Product</option>                                
                          </select>
                           
                         <!--<input type="text" name="cellno" id="cellno" value="" >-->
                         </div>
						 <div class="input_section">
                         <label>If you product is Digital  - Upload MP3/Films</label>
                       ...
                       <div class="input_section" >
                         <label>Upload the Secondary Image of your product</label>
                            <input type="file" name="SecondaryImg[]" id="image"  />
					  ...
					  <div class="input_section" >
                       ...
                       <div class="input_section status" >
                         <label>Status</label>
                           <div id="ac_dact"><input type="radio" name="productStatus" checked="checked" value="1" class="input-status"/>Active
        					<input type="radio" name="productStatus" value="0" class="input-status" />Inactive</div>
                         <!--<input name="city" id="city" type="text" >-->
                       </div>
