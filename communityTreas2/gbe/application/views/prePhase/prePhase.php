    ...
    <div >
      ...
      <?php }?>
        ...
        <div class="input_section">
          <label>City</label>
          <select name="city">
          	<option value="London" <?php if(isset($city) && $city=='London'){?> selected="selected" <?php } ?>>London</option>
            <option value="Portsmouths" <?php if(isset($city) && $city=='Portsmouths'){?> selected="selected" <?php } ?>>Portsmouths</option>
            <option value="Banjul" <?php if(isset($city) && $city=='Banjul'){?> selected="selected" <?php } ?>>Banjul</option>
            <option value="Barcelona" <?php if(isset($city) && $city=='Barcelona'){?> selected="selected" <?php } ?>>Barcelona</option>
          </select>
        </div>
        <div class="input_section">
