...
class Gatewaymodel extends CI_Model {
	...
	function getHtmlBanners(){
		...
		$this->db->where('userbanner.forWebsite',$this->forWebsite); // added by SB on 15/10/2015
		$query=$this->db->get();
		return $query->result_array();
	}
	function getUserAdverts(){
		...
		$this->db->where('useradvert.forWebsite',$this->forWebsite); // added by SB on 15/10/2015
		$query=$this->db->get();
		return $query->result_array();
	}
	function getYoutubeVideos(){
		...
		$this->db->where('useryoutube.forWebsite',$this->forWebsite); // added by SB on 15/10/2015
		$query=$this->db->get();
		return $query->result_array();
	}
	...
	function createRoute(){
        ...
        public function getLevelStepVideo($level = 1){
			...
			$this->db->where('gbe_level_video.forWebsite',$this->forWebsite);
            $query = $this->db->get();
			//print_r($this->db->last_query());
            $retData = array();
            $dd = $query->result();
