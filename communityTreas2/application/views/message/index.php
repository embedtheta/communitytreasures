...
<div class="wrapper">
	...
	<?php	if($mssPayStatus==0){
		?>
           <li <?php if($userInfo[0]['userLevel'] < 1){?> class="levelClass" <?php }?> id="1"><a href="javascript:void(0)" id="gbeLevel1"><span class="level">Q 1 - <i>Open</i></span> CT Catalogue</a></li>
	<?php	}
		else
		{
      ...
      <div class="watch_video_com_trs"><h2>Welcome To <?php echo $userInfo[0]["firstName"];?> <?php echo $userInfo[0]["lastName"];?> V.I.P Suite</h2>
        ...
        <!--<div class="mms_page_frm">
          ...
          <div class="wch_vdo nsfdn">
            ...
            <div class="flw_ibst">
            <h3>The Faster - You Add<br>THe Quicker - You Get Paid!</h3>
            <p><img src="<?php echo base_url();?>images/mse3.png"></p>
            <!--<p>1) Add 12 People   2) Move Up The Level Two  3) Get Paid</p>-->
            </div>
            <!--<div class="rndud"><h5><strong></strong> </h5><img src="img/trophy.png"></div>-->
        ...
        <div class="fm_mss">
          <h3>V.I.P Access For of Your Guests (Only)</h3>
