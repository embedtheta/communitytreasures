...
<body class="monzi_page nutri_page">
<div class="hdrs monzi">
  <div class="wrp">
    
    <h1>For Agents Who Sell Natrition & Weight Management Products</h1>
   
  </div>
</div>
<div class="hdr_btm">
  <div class="wrp">
    <div class="imr_tp"> <img src="<?php echo base_url();?>CT_images/banner_nutrition.jpg" alt=""> </div>
  </div>
</div>
<div class="hdr_mid">
  <div class="wrp"><!--wrp_o-->
    <div class="vws_tp">
      <div id="est_hdn"><img src="<?php echo base_url();?>CT_images/blu-tw3.png" alt=""></div>
      <div id="videoBoxId" class="vws_tp_vdos_o">
        <div class="vws_tp_vdo_sec">
          <div class="vws_tp_vid_dmo">
            ...
            <span name="https://www.youtube.com/embed/VSlWVtgAsq4" id="video_on_id"> <img alt="" src="<?php echo base_url();?>CT_images/vdo_wtaro.png"></span></div>
          <img class="brds" src="<?php echo base_url();?>CT_images/vdo.png" alt=""> </div>
      </div>
      <br class="clear">
    </div>
    <br class="clear">
...
<div class="pkse">
  <div class="wrp">
    ...
    <form id="frms_signup" action="<?php echo base_url();?>dashboard/NutriMonetizer" method="post" enctype="multipart/form-data">
