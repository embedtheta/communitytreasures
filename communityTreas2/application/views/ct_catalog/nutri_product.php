        ...
        <div id="cssmenu">
          <ul>
			<?php if($category_details){
			   ...
			   ?>
				<li><a href="<?php echo base_url();?>dashboard/ct_nutri_product/<?php echo $cd['id'];?>"><?php echo $cd['title'];?></a></li>
			 <?php } }?>
		</ul>
        </div>
      </div>
		 ...
		 <?php } }?>
             ...
             <div class="new_sec_added">
                ...
                <div class="src_catgr scroll-sec">
                	...
                	<!--li><a href="<?php echo base_url();?>dashboard/nutri_buy"><img src="<?php echo base_url();?>/CT_images/Music.jpeg">
    ...
    <div class="bdysec_right">
           ...
           <img class="fmpi palvidd" src="<?php echo base_url();?>/images/no_image.jpg">
            ...
            <div class="fashn_rit event"><h2>Events &amp; Celebrations</h2>
                    	...
                    	<!--a href="http://www.afrowebb.com/welcome/view_Detail/20">
                        <h3>Afro Fashion Expo</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/AfroFashion.jpg">
						Our Afro Fashion Expo is an annual buyers market that showcases the years top designers from Afrowebb. This compilation of style is dedicated to promo.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/21">
                        <h3>CT Business Banquet</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/banquet.jpg">
						Our annual 'CT Business Banquet'  is a large feast complete with delicious Neo-nubian main courses and tasty desserts. This event is held on the last.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/22">
                        <h3>I.B.M.A. Music Awards</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/IBMA.jpg">
						The 'I.B.M.A' - Intelligent Black Music Awards is an accolade presented by CT to honour the biggest hit-makers throughout the&nbsp;Afrowebb network.
Musi.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/23">
                        <h3>Afro Film Festival</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/Afrofilmfest1.jpg">
						Every year it is our privilege to welcome CT members, residents and visitors from around the globe to Afro Film Fest.
The festival is a prominent sho.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/24">
                        <h3>Neo-Nubian Food Expo</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/FoodExpo.jpg">
						Neo Nubian Food Expo celebrates modern fusions of healthy African, Creole &amp; Caribbean food.&nbsp;
This annual event is the premiere trade show for retaile.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/25">
                        <h3>Black &amp; Green Expo</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/Black&amp;Green.jpg">
						The Black &amp; Green show is an international trading platform that showcases the latest innovations in environmental protection from around the world. B.....</p></a>
                        <hr class="hrr">
                        	
                    	<a href="http://www.afrowebb.com/welcome/view_Detail/26">
                        <h3>AfroYoga Rave</h3><p><img width="105" height="105" src="http://globalblackenterprises.com/adminuploads/productPagesImg/yoga-rave.jpg">
						'AfroYoga Rave' brings the spiritual element to Black Business Week.&nbsp;
This movement encourages all people to come together, sharing yoga , music and .....</p></a>
                        <hr class="hrr"-->
                                     </div>
			 			 <br class="clear">
	 	 ...
	 	 <div class="clear"></div>
            ...
            <div id="securityZone">
               ...
               <!-- <a href="http://www.afrowebb.com/welcome/viewDetail/Book/8">
                    <img width="290" height="250" src="http://globalblackenterprises.com/adminuploads/productPagesImg/security.jpg"><p>Arc-Angels Security</p>
                </div>
                         </div-->
            </div>
    <br class="clear">
