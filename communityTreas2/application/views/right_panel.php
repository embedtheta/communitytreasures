<div class="rights_side<?php if($levelName==2){ echo " fulr"; } ?>">
  <div class="blue-box webbox" id="OverView">
    <p class="ana" style="font-weight:bold; font-size: 16px;">I am in Q 5 (Second Cycle) </p>
    <div>
      <ul>
        <li class="mbrs"><strong style="width:60% !important;">My Current Position<span></span></strong> <strong style=" border-radius: 2px !important; padding: 2px 8px !important; width: auto !important; font-size:18px;">1031</strong><br class="clear">
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="webbox">
    ...
    <p class="web"> <a  href="<?php echo base_url();?>myaccount"><span> Rev Share WALLET </span></a></p>
  </div>
  <?php if($levelName==1) { ?>
  <div class="webbox">
  ...
  <?php } ?>
  <div class="webbox"> 
    <!--<p class="web"> <span>My Sign Up Page:</span> <a target="_blank" href="<?php echo base_url()."gateway_signup/".$userInfo[0]["userName"];?>"><?php echo base_url()."gateway_signup/".$userInfo[0]["userName"];?></a> </p>--> <!-- signup is blocked by SB on 05/07/2016 -->
    <p class="web"> <span>My Sign Up Page:</span> </p>
    ...
    <p class="web"> <span>My CT Catalogue :</span> <a target="_blank" href="<?php echo $this->config->item("base_url").'dashboard/CT_catalog/'.$userInfo[0]["userName"];?>"><?php echo $this->config->item("base_url").'dashboard/CT_catalog/'.$userInfo[0]["userName"];?></a> </p>
    <?php if($ct_url!=""){
    ...
    <p class="web"> <span>CT Products:</span> <br>
      ...
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/1">Beauty Products</a> </p>
    <?php } elseif($ct_url == "MEETUPS SUITE") {?>
    <p class="web"> <span>CT Products:</span> <br>
      <!--<a target="_blank" href="<?php echo base_url();?>dashboard/ct_meetsup_product">Meetups Products</a>--> 
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/2">Meetups Products</a> </p>
    <?php } elseif($ct_url == "MODELS SUITE"){?>
    <p class="web"> <span>CT Products:</span> <br>
      <!--<a target="_blank" href="<?php echo base_url();?>dashboard/ct_models_product">Models Products</a>--> 
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/3">Models Products</a> </p>
    <?php } elseif($ct_url == "MUSIC SUITE"){?>
    <p class="web"> <span>CT Products:</span> <br>
      <!--<a target="_blank" href="<?php echo base_url();?>dashboard/ct_music_product">Music Products</a>--> 
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/4">Music Products</a> </p>
    <?php } elseif($ct_url == "NUTRI SUITE") {?>
    <p class="web"> <span>CT Products:</span> <br>
      <!--<a target="_blank" href="<?php echo base_url();?>dashboard/ct_nutri_product">Nutri Products</a>--> 
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/5">Nutri Products</a> </p>
    ...
    <p class="web"> <span>CT Products:</span> <br>
      ...
      <a target="_blank" href="<?php echo base_url();?>dashboard/productCommon_buy/<?php echo $this->session->userdata('userId'); ?>/6">Real Estate Products</a> </p>
    <?php } }?>
    <?php }?>
  </div>
  <?php
  ...
  <div class="webbox"><!-- added for design SB --> 
    ...
    <!--<p class="web"> <span>My Sign Up of Founder Member Page :</span><a target="_blank" href="<?php echo base_url()."signup_founders/".$userInfo[0]["userName"];?>" ><?php echo base_url()."signup_founders/".$userInfo[0]["userName"];?></a> </p>--><!-- signup is blocked by SB on 05/07/2016 -->
    <p class="web"> <span>My Sign Up of Founder Member Page :</span> </p>
    <!-- added by SB on 05/07/2016 -to start signup unblock the above code and block this line of code--> 
  </div>
  <?php }?>
  <?php 
            ...
            ?>
  <div class="webbox"> 
    <!--<p class="web"> <span>My Sign Up of Industry Leader Page :</span> <a target="_blank" href="<?php echo base_url()."signup_industryleader/".$userInfo[0]["userName"];?>" ><?php echo base_url()."signup_industryleader/".$userInfo[0]["userName"];?></a> </p>--><!-- signup is blocked by SB on 05/07/2016 -->
    <p class="web"> <span>My Sign Up of Industry Leader Page :</span> </p>
    <!-- added by SB on 05/07/2016 -to start signup unblock the above code and block this line of code--> 
  </div>
  <!-- added for design SB-->
  <?php }?>
  ...
  <div class="webbox"> 
    ...
    <p class="web"> <span>My Sign Up of Head Volunteers Page :</span> </p>
    <!-- added by SB on 05/07/2016 -to start signup unblock the above code and block this line of code--> 
  </div>
  <!-- added for design SB-->
  <?php }?>
  ...
  <div class="webbox"><!-- added for design SB --> 
    ...
    <p class="web"> <span>My Sign Up of Volunteers Page :</span> </p>
    <!-- added by SB on 05/07/2016 -to start signup unblock the above code and block this line of code--> 
  </div>
  <?php }?>
  <?php
  ...
  <div class="webbox"> 
    ...
    <p class="web"> <span>My Sign Up of Real Estate Page :</span> </p>
    <p class="web"> <span>My Sign Up of Fitness Page :</span> </p>
    <p class="web"> <span>My Sign Up of Food Page :</span> </p>
    <p class="web"> <span>My Sign Up of Hair and Beauty Page :</span> </p>
  </div>
  <?php }?>
  ...
  <div class="ash"> 
    ...
    <span class="ash_postion">You are introduced to Community Treasures by</span> <span class="ash_title"><?php echo $userInfo[0]["firstName"];?> <?php echo $userInfo[0]["lastName"];?></span> <span class="ash_mail phn"> <?php echo $userInfo[0]["phone"];?></span> <span class="ash_mail"><a href="mailto:<?php echo $userInfo[0]["emailID"];?>"> <?php echo $userInfo[0]["emailID"];?></a></span> 
  ...
  <div id="OverView" class="blue-box webbox">
    ...
    <div style="max-height:768px; <?php if(count($overView) > 20):?> overflow-y: scroll;<?php endif;?>">
      <ul>
        <li class="mbrs"><strong>Members Counter:<span>People introduced by me</span></strong> <strong><?php echo count($overView);?></strong><br class="clear">
        </li>
        <?php 
		  if(count($overView) > 0):
