        ...
        <div class="fm_mss add_events">
          ...
          <form action="" method="post" enctype="multipart/form-data">
               ...
               <select id="zip_code_id" name="zip_code_id">
                	<option value="">Select One </option>
                	 <?php if(count($zipList) > 0){ 
                	 			foreach($zipList as $zl){
                            		$selZip = "";
                            		if(isset($eventDetails[0]->zip_code_id) && ($zl['id'] == $eventDetails[0]->zip_code_id)){
                            			$selZip = 'selected="selected"';
                            		} 
                                ?>
                        <option value="<?php echo $zl['id'];?>" <?php echo $selZip;?>><?php echo $zl['zip_code'];?></option>
                        <?php }}?>
              </select>
			...
			<p class="img_uplod">
              ...
              <img width="75" height="75" id="image_path_img_id3" src="<?php echo base_url();?>useruploads/events/<?php echo $eventDetails[0]->image_path3;?>">
              <input type="hidden" name="tempImage3" value="<?php echo $eventDetails[0]->image_path3;?>">
			...
			<p class="img_uplod">
              ...
              <img width="75" height="75" id="image_path_img_id5" src="<?php echo base_url();?>useruploads/events/<?php echo $eventDetails[0]->image_path5;?>">
              <input type="hidden" name="tempImage5" value="<?php echo $eventDetails[0]->image_path5;?>">
			  <?php echo form_error('image_path5', '<span class="form_error">', '</span>'); ?>
            </p>
			<p>
              <label>Video Link</label>
              <input name="video_path" type="text" value="<?php echo $eventDetails[0]->video_path;?>"><i>(youtube embeded link)</i>
			...
			<p class="img_uplod">
              ...
              <img width="75" height="75" id="image_path_img_id2" src="<?php echo base_url();?>useruploads/events/<?php echo $eventDetails[0]->image_path2;?>">
              <input type="hidden" name="tempImage2" value="<?php echo $eventDetails[0]->image_path2;?>">
			...
			<p class="img_uplod">
              ...
              <img width="75" height="75" id="image_path_img_id4" src="<?php echo base_url();?>useruploads/events/<?php echo $eventDetails[0]->image_path4;?>">
              <input type="hidden" name="tempImage4" value="<?php echo $eventDetails[0]->image_path4;?>">
