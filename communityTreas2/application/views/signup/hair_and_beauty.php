...
<div class="hdrs heire">
  <div class="wrp">
    <img src="<?php echo base_url(); ?>images/hair_hdr.jpg" alt=""  />
  </div>
</div>
<div class="hdr_btm">
  <div class="wrp">
    <div class="imr_tp"> 
    <img src="<?php echo base_url(); ?>images/hairimg01.jpg" alt=""  /> 
  </div>
</div>
</div>
<div class="hdr_mid">
    ...
    <div id="est_hdn"><img src="<?php echo base_url(); ?>images/blu-tw.png" alt=""  /></div>
    	...
    	<div id="videoBoxId" class="vws_tp_vdos_o">
                        ...
                        <div class="vws_tp_vid_dmo">
                           ...
                           <img class="brds" src="<?php echo base_url(); ?>images/CTHairBeauty4.jpg" alt=""  />
                            </div>
        </div>
        <br class="clear" />
        </div><br class="clear" />
