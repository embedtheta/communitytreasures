...
<?php echo form_error('skypeID', '<span class="error">', '</span><br>'); ?>
                                    ...
                                    <!--<input type="submit" name="submit" value="Submit">--></p>
                                     <p class="slc_sub">
                                    <input type="submit" name="submit" value="Click here to Pay $40 for Registration" style="width:280px; font-size:15px;">
                                    </p>
                                    </div>
                                <div class="clear"></div>
                        </form>
                        <?php 
                          ...
                          echo "<h2 style=\"color: #80007b;font-size: 28px;font-weight: bold;line-height: 64px;margin-bottom: 70px;font-family: 'Roboto', sans-serif;\">Link has been already activated.</h2>";
                        }
