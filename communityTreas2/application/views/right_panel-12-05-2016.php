    ...
    <div class="webbox1" style="display: none;">
	  ...
	  <div class="webbox">
       ...
       <!--13/10/2015 ujjwal sana commanted  <p class="web"> <span>My Afrowebb Catalogue :</span> 
        ...
        <p class="web"> <span>My Sign Up of Founder Member Page :</span> <a target="_blank" href="<?php echo base_url()."signup_student/".$userInfo[0]["userName"];?>" ><?php echo base_url()."signup_student/".$userInfo[0]["userName"];?></a> </p> 
      </div>
	  <?php }?>
	   <?php 
	  ...
	  <div class="webbox">
        ...
        <p class="web"> <span>My Sign Up of Industry Leader Page :</span> <a target="_blank" href="<?php echo base_url()."signup_teachers/".$userInfo[0]["userName"];?>" ><?php echo base_url()."signup_teachers/".$userInfo[0]["userName"];?></a> </p>
