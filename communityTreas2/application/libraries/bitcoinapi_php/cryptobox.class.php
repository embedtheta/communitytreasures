...
if (CRYPTOBOX_WORDPRESS) { // Pure PHP
   ...
   // require_once( "cryptobox.newpayment.php" );
    ...
    require_once( base_url().'application/libraries/bitcoinapi_php/cryptobox.config.php' ); 
    require_once( base_url().'application/libraries/bitcoinapi_php/cryptobox.newpayment.php' );
}
...
/*echo "<pre>";
           ...
           print_r($cryptobox_localisation);
