...
$(document).ready(function() {
    ...
    $(".levelClass").click(function(){
        ...
        if(id == 2 && userLevel == 1){
           // return true;
            msg = "To Open this section you must complete <br/>Level 1.<br/><h1>Thank you.</h1>";
        ...
        if(id == 3 && userLevel == 2){
            ...
            msg = "To Open this section you must complete <br/>Level 1,2.<br/><h1>Thank you.</h1>";
        }
        if(id == 4 && userLevel == 3){
            return true;
            msg = " Coming soon<br/><h1>Thank you</h1>";
        }else if(id == 4 && userLevel > 3){
            return true;
            msg = "";//" You have already completed this level.<br/>Thank you.";
        }else if(id == 4 && userLevel < 3){
            msg = " Please complete the <br/>Level 1,2,3.<br/><h1>Thank you.</h1>";
        }
        if(id == 5 && userLevel == 4){
            return true;
            msg = " Coming soon<br/> <h1>Thank you</h1>";
        }else if(id == 5 && userLevel < 4){
            msg = " Please complete the previous Level.<br/><h1>Thank you.</h1>";
        }
        if(msg != ""){
            $.fancybox.open(msg);
            return true;
