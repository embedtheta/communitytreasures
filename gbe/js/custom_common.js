...
$(document).ready(function() {
    ...
    if(formSubmitMsg != "" && (formSubmitType == "customer" || formSubmitType == "tech" ||formSubmitType == "advertise" ||formSubmitType == "country" ||formSubmitType == "paypal" || formSubmitType == "image" || formSubmitType == "inviteGmailFriend" || formSubmitType == "inviteYahooFriend" || formSubmitType == "changePassword" || formSubmitType == "pUpload" || formSubmitType == "vUpload" ||formSubmitType == "fListing" || formSubmitType == "deleteUser" ||formSubmitType == "pUploadUpdate" || formSubmitType == "STEP3POSTADD" || formSubmitType == "STEP3POSTCOPY" || formSubmitType == "STEP1A" || formSubmitType == "convertUser")){ 
