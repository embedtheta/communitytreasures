...
$returnUrl = "http://www.globalblackenterprises.com/dashboard?returnFrom=PaypalEntryFees"; // TODO - If you are not executing the Pay call 
                                    // for a preapproval, then you must set a valid 
...
/*if($_REQUEST["parentPaypalID"] == ""){
	$_REQUEST["parentPaypalID"] = "paytestevika-facilitator@gmail.com";
}*/
