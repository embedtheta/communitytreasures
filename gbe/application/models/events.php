...
class Events extends CI_model {
   ...
   public function getEventDetails($id){
	   $this->db->select('GE.*,country.name country_name,city.city city_name,zip_code.zip_code zip_code_name');
	   $this->db->from('gbe_event GE');
	   $this->db->join('country','country.country_id=GE.country_id','LEFT');
	   $this->db->join('city','city.id=GE.city_id','LEFT');
	   $this->db->join('zip_code','zip_code.id=GE.zip_code_id','LEFT');
