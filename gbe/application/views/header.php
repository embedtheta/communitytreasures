    ...
    <div class="nav">
      ...
      <nav class="secondary">
        ...
        <ul class="misc_new">
          ...
          <li <?php if($userInfo[0]['userLevel'] < 1){?> class="levelClass" <?php }?> id="1"><a href="<?php  echo base_url()."dashboard";?>" id="gbeLevel1"><span class="level">Level - 1</span> Afrowebb<span>Open</span></a></li>
