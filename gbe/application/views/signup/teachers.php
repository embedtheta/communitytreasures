...
<html lang="en">
<head>
<title>GBE | TEACHERS</title>
<meta charset="utf-8">
<meta property="og:type" content="website" />
<meta property="og:url" content="<?php echo $ogUrl; ?>" />
<meta property="og:title" content="GBE | TEACHERS" />
...
<header class="sq">
  <div class="hed_inr">
    <!--<h1>--><!--</h1>-->
    <a href="<?php echo base_url(); ?>"><img class="logon" src="<?php echo base_url(); ?>images/logo_sq.png"></a>
    <strong>GBE UNIVERSITY TEACHERS</strong>
    <p class="gbe_log_txt"><img src="<?php echo base_url(); ?>css/signup/images/gbe_img_txt.png" alt="" ></p>
...
<?php } ?>
          ...
          <?php echo form_error('city', '<span class="error">', '</span>'); ?> </div>  
        <div class="input_section">
        </div>
        <div class="input_section">
