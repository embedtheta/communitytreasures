  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>Events Celebration View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addEventsCelebrations">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoEventsCelebrations as $key=>$valCreative){	
			...
			?>
            <tr>
       	      <td class="<?php echo $className;?>"><?php echo $infoEventsCelebrations[$key]["eventTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoEventsCelebrations[$key]["eventImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoEventsCelebrations[$key]["eventDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editEventsCelebrations/<?php echo $infoEventsCelebrations[$key]["eventID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteEventsCelebrations/<?php echo $infoEventsCelebrations[$key]["eventID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
