            	...
            	<table width="600" height="200" border="1" align="center" class="form-table">
     				<tr>
    					...
    					<td><select name="tvType" id="tvType" >
                        		...
                        		<option value=<?php echo $tvType["id"]?>><?php echo $tvType["title"]?></option>
                                <?php } ?>
                            </select>
					...
					<tr>
    					<td>Title</td>
    					<td><input type="text" name="channelTitle" id="channelTitle" class="input1" value="<?php if(isset($channelTitle)){ echo $channelTitle;}?>" />
                    ...
                    <tr>
    					<td>Description</td>
    					<td><textarea name="channelDesc" id="channelDesc" class="input2"><?php if(isset($channelDesc)){ echo $channelDesc;}?></textarea>
					...
					<tr>
    					...
    					<td><input type="file" name="channelVideo" id="channelVideo" class="input-img" />(mp4|flv|avi only supported)
							 ...
							 <?php if(isset($video_error)){ echo '<span class="form_error">'.$video_error.'</span>';}?>
                        </td>
    				</tr>
                    <tr>
     					<td>Status</td>
      					<td>
        					<input type="radio" name="channelStatus" checked="checked" value="1" class="input-status"/>Active
        					<input type="radio" name="channelStatus" value="0" class="input-status" />Inactive
      					</td>
    				</tr>
    				<tr>
    					<td colspan="2">
