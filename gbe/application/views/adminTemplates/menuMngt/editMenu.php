  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	...
    	<div class="main_section">
            ...
            <input type="hidden" name="menuID" id="menuID" value="<?php echo $infoIndivMenu[0]["menuID"];?>"/>
            	<table width="600" height="200" border="1" align="center" class="form-table">
                    ...
                    <tr>
     					<td>Status</td>
      					<td>
                            <input type="radio" name="menuStatus" <?php if($infoIndivMenu[0]["menuStatus"] == "1"){?>checked="checked"<?php } ?> value="1" class="input-status"/>Active
        					<input type="radio" name="menuStatus" <?php if($infoIndivMenu[0]["menuStatus"] == "0"){?>checked="checked"<?php } ?> value="0" class="input-status" />Inactive
      					</td>
    				</tr>
    				<tr>
    					<td colspan="2">
