  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>View List of <?php echo ucwords($selectedUserType);?> User</h2>
            <h3 align="right">
            ...
            <div>
       	  ...
       	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
                ...
                <th width="15%" align="left" scope="col">Invited By</th>
                ...
                <th width="8%" align="left" scope="col">Type</th>
                <th width="8%" align="left" scope="col">City</th>
                <th width="8%" align="left" scope="col">Send Email</th>
                <th width="8%" align="left" scope="col">Status</th>
<!--              <th width="11%" align="left" scope="col">Send Email</th>-->
            ...
            <tr>
                ...
                <td class="<?php echo $className;?>"><?php echo ucwords($valList->user_general_type_name);?></td>
                <td class="<?php echo $className;?>"><?php echo $valList->city_name;?></td>
<td class="<?php echo $className;?>"><?php if($valList->email_send_status > 0){?><input type="checkbox" checked="checked" disabled><?php }else{?><a href="<?php echo base_url();?>emailclass/sendEmailToPayingUserWithCredential/<?php echo $valList->uID;?>" class="sendEmail" id="<?php echo $valList->uID;?>">Send</a><?php }?></td>
