  	...
  	<div class="content-inner">
        ...
        <div class="table-content">
            ...
            <tr>
                ...
                <td class="<?php echo $className;?>"><?php if($valList->email_send_status > 0){?><input type="checkbox" checked="checked" disabled><?php }else{?><a href="<?php echo base_url();?>emailclass/sendEmailToHeadVolunteerWithCredential/<?php echo $valList->uID;?>" class="sendEmail" id="<?php echo $valList->uID;?>">Send</a><?php }?></td>
