  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>Business Consultants View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addBusinessConsultants">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoBusinessConsultants as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoBusinessConsultants[$key]["businessTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoBusinessConsultants[$key]["businessImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoBusinessConsultants[$key]["businessDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editBusinessConsultants/<?php echo $infoBusinessConsultants[$key]["businessID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteBusinessConsultants/<?php echo $infoBusinessConsultants[$key]["businessID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
