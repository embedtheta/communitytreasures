  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>News Zone View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addNewsZone">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoNewsZone as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoNewsZone[$key]["newsTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoNewsZone[$key]["newsImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoNewsZone[$key]["newsDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editNewsZone/<?php echo $infoNewsZone[$key]["newsID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteNewsZone/<?php echo $infoNewsZone[$key]["newsID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
