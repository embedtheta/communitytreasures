  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>Mentorship View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addResidential">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoResidential as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoResidential[$key]["residentialTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoResidential[$key]["residentialImage"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoResidential[$key]["residentialDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editResidential/<?php echo $infoResidential[$key]["residentialId"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteResidential/<?php echo $infoResidential[$key]["residentialId"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
