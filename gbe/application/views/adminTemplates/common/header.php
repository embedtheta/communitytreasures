...
<ul id="i2i-menu" class="i2i-menu-main">
    ...
    <nav class="i2i-menu-wrapper i2i-open-all i2i-open-part">
        ...
        <ul class="i2i-menu">
				  ...
				  <!--<li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/viewCategoryList"><i class="fa fa-picture-o"></i>Manage Catalogue Category</a></li>-->
				  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/viewCategory"><i class="fa fa-picture-o"></i>Manage Category</a></li>
                  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/viewAdsList/ "><i class="fa fa-picture-o"></i>Manage Ads</a></li>
				  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/manageDiscountLink/ "><i class="fa fa-picture-o"></i>Manage Discount Link</a></li>
                  ...
                  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/mmsHvolunteer"><i class="fa fa-picture-o"></i> Convert Afrowebb to Volunteer</a>
                  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/showGambianAssignResult"><i class="fa fa-picture-o"></i> Assign Gambian to User</a>
            ...
            <ul class="i2i-submenu">
                      ...
                      <li><a href="<?php echo base_url(); ?>cp/viewTeacher" class="i2i-icon"><i class="fa fa-eye"></i><?php if(trim($this->session->userdata('forWebsite'))==2){ echo 'Industry Leader'; }else{ echo 'Teachers';} ?></a></li>
                      <li><a href="<?php echo base_url(); ?>cp/viewStudent" class="i2i-icon"><i class="fa fa-eye"></i><?php if(trim($this->session->userdata('forWebsite'))==2){ echo 'Founder'; }else{ echo 'Students';} ?></a></li>
            ...
            <ul class="i2i-submenu">
				  ...
				  <li><a class="i2i-icon" href="<?php echo base_url(); ?>admin/viewSourceZone"><i class="fa fa-picture-o"></i> CT Source </a></li>
<!--below menu added by SB on 25/02/2016 --->		 
		 <?php  if(trim($this->session->userdata('forWebsite'))==2){?>
		  <li><a class="i2i-icon" href="<?php echo base_url(); ?>admin/viewCTfooterBanner"><i class="fa fa-picture-o"></i> CT Footer Banner</a></li>
		  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/ctLevelWiseVideoList"><i class="fa fa-picture-o"></i> View Monetizer Level Wise Detail</a></li>
		  <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/ctBlogVideo"><i class="fa fa-picture-o"></i> CT Blog Video Detail</a></li>
		  <?php } ?>
                </ul>
      </div>
              <!-- /i2i-scroller --> 
          ...
          <li class="i2i-logo"><?php if(trim($this->session->userdata('forWebsite'))==1){ ?><img src="<?php echo base_url(); ?>images/admin-logo-inner.png" alt=""><?php }
		   else if(trim($this->session->userdata('forWebsite'))==2){?> <img src="<?php echo base_url(); ?>images/logo_community.png" alt=""><?php }else { ?><img src="<?php echo base_url(); ?>images/logo_rave.png" alt=""> <?php } ?></li>
