                    ...
                    <nav class="i2i-menu-wrapper i2i-open-all i2i-open-part">
                        <div class="i2i-scroller">
                            <ul class="i2i-menu">
                                ...
                                <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/gbeLevelWiseVideoList"><i class="fa fa-picture-o"></i> View GBE Level Wise Video</a></li>
                             <!--<li><a class="i2i-icon" href="<?php echo base_url(); ?>admin/viewCentoruList"><i class="fa fa-picture-o"></i> View Centoru List</a></li>-->
                                <li><a class="i2i-icon" href="<?php echo base_url(); ?>cp/allTypeUser"><i class="fa fa-picture-o"></i> User Management</a>
                                    <ul class="i2i-submenu">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>cp/viewPayingUser" class="i2i-icon"><i class="fa fa-eye"></i>Paying Users</a></li>
                                ...
                                <li><a class="i2i-icon" href="<?php echo base_url(); ?>admin/user_youtube"><i class="fa fa-video-camera"></i>Youtube Management</a></li> 
