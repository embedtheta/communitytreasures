                ...
                <table width="600" height="200" border="1" align="center" class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($val->content_image!=""){?><div style="height: 120px;width: 100px;"><img height="100" width="120" src="<?php echo base_url().'adminuploads/level_wise_images/'.$val->content_image;?>" alt=""></div><?php }?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="submit" name="submit" id="submit" value="save" class="submit-bnt" />&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/dashboard">cancel</a>
                        </td>
                    </tr>
                </table>
            </form>
