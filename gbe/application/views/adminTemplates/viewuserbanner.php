		...
		?>
          <div class="table-content" id="dashreload">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <th scope="col"><a href="<?php echo base_url();?>admin/bannerMembership/<?php echo $view->bannerID ;?>">Edit</a>||<a href="javascript:void(0)" onClick="delBanner('<?php echo $view->bannerID ;?>')">Delete</a></th>
