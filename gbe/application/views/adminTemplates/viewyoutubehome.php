...
function delElement(entityID){
	...
	if( confirmationDelete == true ){
		...
		window.location.href = '<?php echo base_url();?>admin/deleteEntityyoutube/'+entityID;
	}else{
...
<div class="container">
  ...
  <div class="content-wrapper">
    	...
    	<div class="page-title">
            <h2>UserYoutube</h2>  <h3 align="right"><a href="<?php echo base_url();?>admin/Adduseryoutube">Add</a></h3>
        </div>
        
         
        <!--Success-->
        <?php if(isset($st) && ( $st == "delete")) {?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <div class="table-content" id="dashreload">
       	   <form name="checkSubmit" id="checkSubmit" action="<?php echo base_url();?>index.php/homelogin/remove_checkedyoutube" method="post" >
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
       	      <th scope="col"><input type="checkbox" id="selectall"/></th>
              <th scope="col">id</th>
              <th scope="col">youtube Name</th>
            ...
            <tr>
            <th scope="col"><input type="checkbox" class="msg" name="msg[]" value="<?php echo $view->id; ?>"/></th>
            <th scope="col"><?php echo $view->id; ?></th>
            <th scope="col"><?php echo $view->youtubeName; ?></th> 
            <th scope="col"><?php echo $view->youtubeUrl; ?></th> 
            <th scope="col"><?php if($view->status == 1){ echo "active"; }elseif($view->status == 0){ echo "deactive";  }?></th>
            <th scope="col"><a href="<?php echo base_url();?>admin/youtubeMembership/<?php echo $view->id ;?>">Edit</a>||<a href="javascript:void(0)" onClick="delElement('<?php echo $view->id ;?>')">Delete</a></th>
