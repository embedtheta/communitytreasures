  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>View Catalogue Category List</h2>
        ...
        <div class="table-content">
       	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <th width="13%" align="left" scope="col">Description</th>
            ...
            <tr>
				...
				<td class="<?php echo $className;?>"><a href="<?php echo base_url();?>cp/editCategory/<?php echo $valList->id;?>">Edit </a><!--|<a href="<?php echo base_url();?>cp/deleteCategory/<?php echo $valList->id;?>" onclick=" return confirm('Are you sure to delete this data?');">Delete </a>--></td>
