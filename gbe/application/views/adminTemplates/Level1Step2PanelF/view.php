  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>View Listing</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/user_advert_add/<?php echo $page;?>">Add</a>
            </h3> 
        </div>
        ...
        <div class="table-content">
       	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
                ...
                <th width="35%" align="left" scope="col">Image</th>
			...
			?>
             <tr>
                ...
                <td class="<?php echo $className;?>"><?php echo $valList->advertTitle;?></td>
                <td class="<?php echo $className;?>"><img width="200" height="150" alt="" src="<?php echo base_url();?>adminuploads/advert/<?php echo $valList->advertImg?>"></td>
      
                <td class="<?php echo $className;?>"> <?php if($valList->status == "1"){?>Active<?php }else{?>Inactive<?php }?> </td>
                <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/user_advert_edit/<?php echo $valList->advertID;?>/<?php echo $page;?>">Edit</a> ||<a onclick="return confirm('Are you sure to delete this Record.')" href="<?php echo base_url();?>admin/user_advert_delete/<?php echo $valList->advertID;?>/<?php echo $page;?>">Delete</a></td>
   	    </tr>
            <?php } 
                }else{
            ?>
