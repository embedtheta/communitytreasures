  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>Security View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addSecurity">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoSecurity as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoSecurity[$key]["securityTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoSecurity[$key]["securityImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editSecurity/<?php echo $infoSecurity[$key]["securityId"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteSecurity/<?php echo $infoSecurity[$key]["securityId"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
