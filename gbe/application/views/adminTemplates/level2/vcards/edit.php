            ...
            <div class="main_section">
            	...
            	<table width="700" height="200" border="1" align="center" class="form-table">
                    ...
                    <tr>
                        ...
                        <div id="contact-image"><img alt="" src="<?php echo base_url().'adminuploads/brochureVcards/vcards/'.$details[0]->cover_img;?>" id="empPic" height="90" width="90" ></div></td>
    				</tr>
                    
    				<tr>
    					<td colspan="2"><input type="submit" name="add" value="Update" class="submit-bnt" /> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>cp/listingVCards/<?php echo $page;?>" class="submit-bnt">Back</a></td>
    				</tr>
  				</tbody></table>
                </form>
