    	...
    	<div class="main_section">
        	<form id="addCreative" name="addCreative" method="post" action="" enctype="multipart/form-data" class="main_form">
            	<table width="600" height="200" border="1" align="center" class="form-table">
     				<tr>
    					<td>Title</td>
    					<td><input type="text" name="creativeTitle" id="creativeTitle" class="input1" value="<?php if(isset($creativeTitle)){ echo $creativeTitle;}?>" />
      						<?php echo form_error('creativeTitle', '<span class="form_error">', '</span>'); ?>
    					</td>
    				</tr>
                    <tr>
    					<td>Description</td>
    					<td><textarea name="creativeDesc" id="creativeDesc" class="input2"><?php if(isset($creativeDesc)){ echo $creativeDesc;}?></textarea>
                    ...
                    <tr>
     					<td>Status</td>
      					<td>
        					<input type="radio" name="creativeStatus" checked="checked" value="1" class="input-status"/>Active
        					<input type="radio" name="creativeStatus" value="0" class="input-status" />Inactive
      					</td>
    				</tr>
    				<tr>
    					<td colspan="2">
