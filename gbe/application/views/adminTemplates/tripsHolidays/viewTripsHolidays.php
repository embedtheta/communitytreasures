  ...
  <div class="content-wrapper">
  	<div class="content-inner">
    	<div class="page-title">
            <h2>Trip Holidays View</h2>
            <h3 align="right">
                 <a href="<?php echo base_url();?>admin/addTripsHolidays">Add</a>
            </h3>
        </div>
        ...
        <div class="table-content">
            ...
            <?php // print_r($infoCreative);
				  foreach($infoTripsHolidays as $key=>$valCreative){	
            ...
            <tr>
       	      ...
       	      <td class="<?php echo $className;?>"><?php echo $infoTripsHolidays[$key]["tripTitle"];?></td>
       	      <td class="<?php echo $className;?>"><img src="<?php echo base_url();?>/adminuploads/productPagesImg/<?php echo $infoTripsHolidays[$key]["tripImg"];?>" width="107" height="107"/></td>
       	      <td class="<?php echo $className;?>"><?php echo $infoTripsHolidays[$key]["tripDesc"];?></td>
       	      <td class="<?php echo $className;?>"><a href="<?php echo base_url();?>admin/editTripsHolidays/<?php echo $infoTripsHolidays[$key]["tripID"];?>">Edit </a> | <a href="<?php echo base_url();?>admin/deleteTripsHolidays/<?php echo $infoTripsHolidays[$key]["tripID"];?>">Delete</a></td>
   	        </tr>
            <?php } ?>
       	   <!-- <tr>
