        ...
        <div class="white-bg">
          ...
          <div class="blog_page">
            ...
            <div class="<?php echo $class;?>">
              ...
              <div class="short_dsc"><?php if(strlen($bv->post_content) > 115){ echo substr($bv->post_content,0,115).' ...';}else{ echo $bv->post_content; } ?></div>
              <div class="share_rdmr"> <a href="<?php echo base_url().'blog/view/'.$bv->post_title_url;?>">Read More</a>
                <div class="shre_ths"> 
                	...
                	<!--<span class="st_facebook_large" displayText="Facebook" onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo $bv->post_title;?>&amp;p[summary]=<?php echo $bv->post_title;?>&amp;p[url]=<?php echo base_url().'blog/view/'.$bv->post_title_url;?>', 'sharer', 'toolbar=0,status=0,width=550,height=400');"></span> 
              ...
              <div class="blgnew_img"><img src="<?php echo base_url();?>useruploads/blogs/others/<?php if($bv->post_image != ''){?><?php echo $bv->post_image;?><?php }else{?>blog_blank.png<?php }?>" alt=""></div>
