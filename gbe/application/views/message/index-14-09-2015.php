    ...
    <div class="nav">
      <nav class="secondary">
        <ul class="misc_new">
         ...
         <li id="1"><a href="<?php echo base_url()."dashboard";?>" id="gbeLevel1"><span class="level">Level - 1</span> Afrowebb<span>Open</span></a></li>
      ...
      <div class="mms_page">
        <div class="mms_page_frm">
          <div class="wch_vdo">
            ...
            <a href="javascript:void(0);" name="https://www.youtube.com/embed/zILF2fLhW_E" id="videoLinkId">
                <div class="wtch_vio">
        ...
        <div class="fm_mss">
         ...
         <?php echo form_error('emailAddr', '<span class="form_error">', '</span>'); ?>
            ...
            <p>
              ...
              <?php else:?>
              <select name="city">
              <option value="<?php echo $userInfo[0]['city_id']?>" selected><?php echo $userInfo[0]['city']?></option>
              </select>
              <?php endif;?>
