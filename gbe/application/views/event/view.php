      ...
      <div class="mms_page"> 
        ...
        <div class="fm_mss add_vew">
          ...
          <div class="add_vw_left">
            ...
            <p>
              <label>Image</label>
              <img width="75" height="75" id="image_path_img_id" src="<?php echo base_url();?>useruploads/events/<?php echo $eventDetails[0]->image_path;?>"> </p>
          </div>
          <div class="add_vw_rits">
            ...
            <p>
              ...
              <strong><?php echo $eventDetails[0]->desc;?></strong> 
              <?php echo form_error('desc', '<span class="form_error">', '</span>'); ?> </p>
          </div>
          <div class="clear"></div>
          <input name="button" type="reset" value="Back" onClick="window.location='<?php echo base_url();?>fullmembers'">
          <div class="clear"></div>
        </div>
      </div>
    </div>
