                     ...
                     <select id="city" name="city">
                        ...
                        <?php if(count($cityList) > 0){ 
                            foreach($cityList as $cl){
                                ?>
                        <option value="<?php echo $cl['id'];?>" <?php if($cl['id'] == $userInfo[0]["city"]){?> selected="selected" <?php }?>><?php echo $cl['city'];?></option>
                        <?php }}?>
                      </select>
                  
                 
                  <span class="addcityclass" ><a href="javascript:void(0)" onClick="openCityAddCityDiv();"><em>Add Your City To The List. - Click here</em> </a></span>
