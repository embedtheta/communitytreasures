...
$db['default']['username'] = 'ravebusi_master';
$db['default']['password'] = 'dhT!M%y)MQQ6';
$db['default']['database'] = 'ravebusi_gbe';
*/
...
$db['ADMINDB']['username'] = 'ravebusi_democt';
$db['ADMINDB']['password'] = 'Server12#';
$db['ADMINDB']['database'] = 'ravebusi_livect';
