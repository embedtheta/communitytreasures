    ...
    public function sendEmailToHeadVolunteerWithCredential($id = 0) {
        ...
        if ($id != '') {
            ...
            $message = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr><td colspan="2">Below is your username and password to enter your Head Volunteer Account.</td></tr>
                            <tr><td colspan="2">Now you can Start to build your GBE Business, Grow your team and better 
...
<tr><td colspan="2">Here is your login credentials as below.</td></tr>
    ...
    public function sendEmailToTeacherWithCredential($id = 0) {
        ...
        if ($id != '') {
            ...
            $message = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td colspan="2">Hello ' . $retValue[0]->firstName . ',</td></tr>
                             <tr><td colspan="2">Below is your username and password to enter your Teachers Account.
Now you can Start to build your GBE Business and make money.
You can change your password once you are inside your account.</td></tr>  
<tr><td colspan="2">Remember This is Your Moment! </td></tr>
<tr><td colspan="2">Recruit and Teach as many Students as possible.</td></tr>
<tr><td colspan="2">Your Target should be 50 Students or more in Your Online Class.</td></tr>
<tr><td colspan="2">Good Luck.</td></tr>
                            <tr><td colspan="2">Here is your login credentials as below.</td></tr>
                            <tr><td width="25%">Username:</td><td width="75%">' . $retValue[0]->emailID . '</td></tr>
                            <tr><td width="25%">Password:</td><td width="75%">' . $password . '</td></tr>
