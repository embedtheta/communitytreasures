...
class Admin extends CI_Controller {
    ...
    public function addCreative() {
        ...
        if (trim($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() != FALSE) {
                $lastInsertId = $this->data_model->insertCreativeDetails($viewData);
                if ($lastInsertId > 0) {
        ...
        $this->load->view('adminTemplates/creative/addCreative', $viewData);
    }
    ...
    public function viewProduct() {
        ...
        $viewData["infoProducts"] = $this->data_model->getAllProducts();
