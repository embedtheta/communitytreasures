...
foreach ($viewData['userListDetail'] as $key=>$line)
  {
      ...
      $referrerDetails = $this->getReferalIdDetails($line['referarID']);
...
public function sponsorList() { //echo $this->session->userdata('emailId')."++++".$this->session->userdata('userType'); die;
