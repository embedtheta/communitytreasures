...
jQuery(function ($) {
	...
	$('.clickopen').toggle(function () {
            $("#togldiv").slideUp("slow");
	},function () {
            $("#togldiv").slideDown("slow");
	}
	);
...
<div id="levelup_alert" class="switch mov_up"><a href="javascript:;" class="close_btn_level" title="Close"></a>
  ...
  <h3 style="  font-family: arial; font-size: 26px; line-height: 38px;">You Have successfully Joined The Queue.<br />
For This Week You Will Not Have To Watch Ads<br />
But You Must Complete One (1) Task per day<br />
To Move Up the Queue.</h3>
  ...
  <div class="switch_extrapara">
    <p class="swt_img"><a id="moveUp" href="javascript:;"><img width="424" height="81" style="cursor:pointer" alt="" src="<?php echo base_url();?>images/move_up1.png"></a></p>
  </div>
</div>
</div>
</div>
...
?>
			  ...
			  <!--  added by SB on 29-04-2016  start -->
			  <div class="ab_inner"><strong>E</strong>
                <h3 class="d_hdr">Verification</h3>
              ...
              <div class="verification_formsec">
               <p style="float:left;">
                       <label>Upload your proof of identification</label>
                       <div class="input-note">
                       <input name="" type="file" style="background: #f0f0f0; border: 1px solid #a0a0a0; border-radius: 2px; color: #848484; padding: 4px; width: 100%;" />
<span>N.B: (Passport, Personal ID or Governmental ID, Driving Licence) in Image format only (jpg, gif, png)</span>
                       </div>
                      </p>
                        <p style="float:left;">
                       <label>Upload your proof of address </label>
                        <div class="input-note">
                      <input name="" type="file"   style="background: #f0f0f0; border: 1px solid #a0a0a0; border-radius: 2px; color: #848484; padding: 4px; width: 100%;" />
                      <span>N.B: in image format only(jpg, gif, png)</span>
                       </div>
                      </p>
              </div>
			   </div>
			   <!--  added by SB on 29-04-2016  end -->
               
                <!--  added by SB on 29-04-2016  start -->
			  <div class="ab_inner"><strong>F</strong>
                <h3 class="d_hdr">Create Security PIN<br />
(Chose 4 digit number)</h3>
                <span id="passCh"><a class="watch-video-tut1" name="<?php echo $stepWiseVideo[1]["I"]["path"];?>" id="tutorial-videoSH" href="javascript:void(0)">Watch Video</a></span> </div>
			   <div class="white-space">
              <div class="verification_formsec">
              <br />
                        <p>
                       <label>Security PIN <br />
(4 digit number)</label>
                      <input name="" type="text" />
                      </p>
                    <p>
                        <input type="submit" onclick="return passwordCheck();" id="passwordUpdate" name="passwordUpdate" value="update PIN">
                      </p>   
			  ...
			  <div class="ab_inner"><strong>G</strong>
                <h3 class="d_hdr">Choose Where We Pay You</h3>
                <span id="passCh"><a class="watch-video-tut1" name="<?php echo $stepWiseVideo[1]["I"]["path"];?>" id="tutorial-videoSH" href="javascript:void(0)">Watch Video</a></span> </div>
			   <div class="white-space">
              <div class="verification_formsec">
              <h2>Choose Where We Pay You</h2>
              <br />
               <p>
              ...
              <p> <i>NB: Ensure that you enter the corect account payment name or email for receiving funds to save any delays.</i></p>
              </div>
			   </div>
			   <!--  added by SB on 29-04-2016  end -->
               
                <!--  added by SB on 29-04-2016  start -->
			  <div class="ab_inner"><strong>H</strong>
                <h3 class="d_hdr">Payments Details</h3>
                <span id="passCh"><a class="watch-video-tut1" name="<?php echo $stepWiseVideo[1]["I"]["path"];?>" id="tutorial-videoSH" href="javascript:void(0)">Watch Video</a></span> </div>
			   <div class="white-space">
              <div class="verification_formsec">
              <h2>Personal Info</h2>
              <br />
                      ...
                      <input type="submit" onclick="return passwordCheck();" id="passwordUpdate" name="passwordUpdate" value="update Contact Info" style="width:57%;">
			   ...
			   <!--  added by SB on 29-04-2016  end -->
			   <!--<br class="clear">
              <div class="ab_inner"><strong><?php echo $stepWiseVideo[1]["I"]["serial_field"];?> </strong>
                <h3 class="d_hdr"><?php echo $stepWiseVideo[1]["I"]["title"];?></h3>
                <span><a class="watch-video-tut" id="tutorial-video1e" name="<?php echo $stepWiseVideo[1]["I"]["path"];?>" href="javascript:void(0)">Watch Video</a></span> </div>
              <div class="white-space">
                <p style="margin-bottom: 30px;"><?php echo $stepWiseVideo[1]["I"]["content"];?></p>
              ...
              <div class="ab_inner"><strong><?php echo $stepWiseVideo[1]["I"]["serial_field"];?> </strong>
                <h3 class="d_hdr"><?php echo $stepWiseVideo[1]["I"]["title"];?></h3>
                <span><a class="watch-video-tut" id="tutorial-video1f" name="<?php echo $stepWiseVideo[1]["I"]["path"];?>" href="javascript:void(0)">Watch Video</a></span> </div>
              ...
              <div class="ab_inner"><strong><?php echo $stepWiseVideo[1]["J"]["serial_field"];?> </strong>
                <h3 class="d_hdr"><?php echo $stepWiseVideo[1]["J"]["title"];?></h3>
                <span id="passCh"><a class="watch-video-tut1" name="<?php echo $stepWiseVideo[1]["J"]["path"];?>" id="tutorial-videoSG" href="javascript:void(0)">Watch Video</a></span> </div>
...
<br />
               ...
               <br class="clear" />
			  <p align="right" style="margin-right: 35px;  margin-top: 20px;"><a id="step2" href="javascript:void(0)" rel="tab2" onclick="showSecondTab()" style=" background:#1b75bc; border-radius: 5px; color: #fff;  font-size: 22px; padding: 10px;">Now Complete Step 2 ></a></p>
 ...
 Invite People To Join Your Rave Business 
            ...
            <div>
			  ...
			  <div class="white-space pp st1">
                  ...
                  <form enctype="multipart/form-data" action="<?php echo base_url();?>dashboard/updateUserInfoNew" method="post" id="frm_new">
                   <h3 style="margin-bottom: 8px; padding-left:38px;"><?php echo $stepWiseVideo[2]["A"]["content"];?></h3>
              ...
              <div class="white-space">
                ...
                <div class="clk_pr_inv" id="togldiv">
				 <ul>
                  <?php 
                    if(count($step2Url) > 0):
             ...
             <!--  <div class="clear"></div>
              ...
              <div class="white-space">
                <div class="extra-share">
                  ...
                  <div class="share-pic"><img class="share-none" width="106" height="150" src="<?php echo $this->config->item('gbe_base_url');?>adminuploads/level_wise_images/<?php echo $stepWiseVideo[2]["G"]["content_image"];?>"></div>
                  <div class="clear"></div>
                </div>
              </div>
              <!--div class="clear"></div-->
            ...
            <!--  <div class="clear"></div>
              ...
              <div class="ab_inner"><strong><?php echo $stepWiseVideo[2]["J"]["serial_field"];?> </strong>
				...
				<div class="white-space">
                <h3 class="new_head"><?php echo $stepWiseVideo[2]["J"]["content_title"];?></h3>
                <p><?php echo $stepWiseVideo[2][1]["content"];?></p>
                <div id="cont" style="display:none;">Lorem ipsum </div>
                <div class="website-icon"> <a href="<?php echo $urlGmailYahoo['gmail'];?>" target="_blank" style="font-size:25px;font-weight:bold;"><img class="nobor" src="<?php echo base_url(); ?>images/gmail.png" width="95" height="70" alt=""></a> <a href="<?php echo $urlGmailYahoo['yahoo'];?>" target="_blank"><img class="nobor" src="<?php echo base_url(); ?>images/yahoo.png" width="114" height="70" alt=""></a> </div>
              </div>
