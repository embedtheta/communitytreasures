            ...
            <!--  <div class="clear"></div>
              ...
              <div class="white-space">
                ...
                <ul class="presta_shop">
                  <?php foreach( $htmlBanners as $key=>$val){?>
                  <li>
                    <div class="prest_sp_li"><a href="#"><img src="<?php echo $this->config->item('gbe_base_url'); ?>CT_sponcer_img/<?php echo $htmlBanners[$key]["bannerImage"];?>"></a></div>
	...
	if($moneBannerImage[0]['bannerTitle']!=""){
		$bannerTitle = $moneBannerImage[0]['bannerTitle'];
			...
			if($moneBannerImage[0]['bannerImage']!=""){
				   ?>
				   <img width="70" height="70" alt="" src="<?php echo $this->config->item('gbe_base_url'); ?>CT_sponcer_img/<?php echo $moneBannerImage[0]['bannerImage']; ?>" style="margin-right:25px;" id="empPic_ct"> 
              <?php 
			   }else{
				   ?>
		 ...
		 <p style="margin-bottom:26px;">Upload Your Banner</p>
                  <form class="rday" method="post" action="<?php echo base_url();?>dashboard/CT_BannerUpload/<?php echo $ct_pageId;?>" enctype="multipart/form-data">
                    <label style="display: block; clear: both;">
					<p>Banner Title:</p>
					<input type="text" id="bannerTitle" name="bannerTitle" value="<?php echo $bannerTitle; ?>" >
