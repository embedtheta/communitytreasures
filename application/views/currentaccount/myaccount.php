          ...
          <div id="tab1" class="tab_content">
            <div class="white-bg">
              <div class="left_hding">
                <h3 style="color:#7e007e;">My Wallet</h3>
              ...
              <div class="table_tab_rd">
                ...
                <div class="tabfull marginbottom">
                  <div id="tab6" class="divtabClass">
                    <div class="transec_glce">
					  ...
					  foreach($AllCom as $paymentCommDetail){
						  ...
						  ?>
                          <tr>
						  <?php if($paymentCommDetail['transaction_Id']!=""){?>
						  <td onclick="showPopUpDiv(<?php echo $paymentCommDetail['transaction_Id']; ?>,'SwitchOn');"><?php echo $paymentCommDetail['transaction_Id']; ?></td>
						  <?php } else {?>
							<td><?php echo $paymentCommDetail['transaction_Id']; ?></td>
						  <?php }
						  ?>
						   <td align="center"><?php echo $paymentCommDetail['firstName']." ".$paymentCommDetail['lastName']; ?></td>
                            <td align="center"><?php echo $paymentCommDetail['userLevel']; ?></td>
                            <td style="text-align:center;"><?php echo $paymentCommDetail['paymentGrossAmt']; ?></td>
                            <td style="text-align:center;"><?php echo $paymentCommDetail['createdDate']; ?></td>
                            <td style="text-align:center;"><?php echo $paymentCommDetail['paymentAmt']; ?></td>
                          </tr>
                          <?php
                  ...
                  <div id="tab8" style="display:none;" class="divtabClass">
                    <div class="transec_glce" style="text-align:center;"><br class="clear">
                       Coming Soon
                      <br><br>
</div>
                  </div>
              ...
              <div class="table_tab300">
                ...
                <div class="tabfull marginbottom"> 
                  ...
                  <div id="tab11" class="divtabClass1" style="display:none;">
                    <div class="transec_glce" style="text-align:center;">
                    <br class="clear">
                     Coming Soon
                      <br>
<br>
          ...
          <div id="tab2" class="tab_content" style="display:none;"> 
            ...
            <div class="currncy_lf">
              <div class="left_hding">
                <h3 style="color:#7e007e;">All Transctions</h3>
                <p>You Are Currently On Level - <?php echo $userInfo[0]['userLevel'];?></p>
              </div>
          ...
          <div id="tab3" class="tab_content" style="display:none;"> 
            ...
            <div class="">
              <div class="left_hding">
                <h3 style="color:#7e007e;">Withdrawal Payment</h3>
                <p>You Are Currently On Level - <?php echo $userInfo[0]['userLevel'];?></p>
              </div>
              <div class="clear"></div>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody id="rowValId">
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $allWithdrawalDetail['paymentAmt']; ?></td>
                      <td style="text-align:center;"><?php echo  $currBalance;?></td>
          ...
          <div id="tab4" class="tab_content" style="display:none;"> 
            ...
            <div class="">
              <div class="left_hding">
                <h3 style="color:#7e007e; font-size:34px;">Notifications</h3>
                <p>You Are Currently On Level - <?php echo $userInfo[0]['userLevel'];?></p>
              </div>
              <div class="notification-section">
                ...
                <div class="notification-formmsec">
                  <h4 style=" color: #7e007e; font-size: 20px;">Type your Notification</h4>
                  <form action="" method="post">
          ...
          <div id="tab5" class="tab_content" style="display:none;">
            <div class="left_hding"><h3 style="color:#7e007e; font-size:34px;">Reward point </h3><br>
                  Coming Soon
   ...
   <div class="rights_side currncy_rit">
      ...
      <div class="webbox mdle_rdse">
        ...
        <ul>
          ...
          <li><a href="#">My next CommunityTreasures renewal Date</a></li>
      ...
      <div class="webbox mdle_rdsess">
        ...
        <form action="" method="post">
          ...
          <p>
            ...
            <input type="text" id="paypalacid" value="<?php echo $userInfo[0]["paypalAC"];?>">
            <br class="clear">
          </p>
          <p class="rqst_pp_acnt"><a onClick="editpaypalAc()">Request to change you Paypal Account</a></p>
        </form>
      </div>
    </div>
    <br class="clear">
...
//2/11/2015 added ujjwal sana
 function editpaypalAc(){
	 var selectedPaypalAcId =$('#paypalacid').val();
	 var retEmail = emailValidation(selectedPaypalAcId);
	// alert(retEmail);
	 if(selectedPaypalAcId!='' && retEmail==""){
			$.ajax({
			 type: "POST",
			 url:  "<?php echo base_url();?>currentaccount/editPaypalAcID", 
			 data: "paypalAc="+selectedPaypalAcId,
			 cache:false,
			 dataType: "json",
			 success: 
				  function(data){
