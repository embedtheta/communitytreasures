...
<div class="top-login">
  ...
  <div style="min-height:350px;">
    <div class="middle-contentsec">
    	...
    	<div class="payment_fler_div">
           <h3>Payment not SuccessFull</h3>
           <div class="pay_succ_inr">
           <div class="pay_succ_inr_lft"><img src="<?=base_url()?>images/payment/fler.png" alt=""  /></div>
           <div class="pay_succ_inr_rit">
<p>Unfortunately, either you payment was not authorised by your payment authority or you have cancelled the payment. Do you want to try to make the payment again. Please click on <strong>"Retry"</strong> button to proceed or click on <strong>"Cancel"</strong> to cancel the payment. 
Thank you for your kind cooperation.</p>
           <div class="print_btn">
           	<a href="<?=base_url()?>payment"><img src="<?=base_url()?>images/payment/rty.png" alt="" /></a><a href="<?=base_url()?>"><img src="<?=base_url()?>images/payment/cnzl.png" alt="" /></a>
           </div></div>
           <br class="cl">
</div>
           </div>      
