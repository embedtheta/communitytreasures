...
var functionUrl		= "<?=base_url()?>payment/chkUser/";
	...
	$(document).ready(function() {
		...
		{
			$("#signupForm").hide();
			var testItem	= $("#sel_title").val()+"||"+$("#first_name").val()+"||"+$("#last_name").val()+"||"+$("#midname").val()+"||"+$("#email").val()+"||"+$("#phoneno").val()+"||"+$("#cat_name").val()+"||"+$("#country_name").val()+"||"+$("#industry").val()+"||"+$("#amount").val()+"||"+$("#user_id").val()+"||"+"BB";
            //alert(testItem);
    ...
    <div class="middle-contentsec">
           ...
           <div class="payment_frm personal-details"> 
                ...
                <div class="payment_frm_dv">
                  ...
                  <input type="text" id="midname" name="midname" readonly />
                </div>
                <div class="payment_frm_dv">
           ...
           <div class="payment_frm payment-details">
            <h2>Payment Detail</h2>  
                ...
                <div class="payment_frm_dv ">
                  ...
                  <input type="text" id="amount" name="amount" style="padding-left: 12px; width: 336px;" value="<?php if(isset($acc_price)){ echo $acc_price; }?>"/> 
