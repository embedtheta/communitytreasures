...
<div class="wrp">
	<div class="hdr_top"><img src="<?php echo base_url(); ?>images/grn_top_log.jpg" alt=""  /></div>
...
<div class="wrp_o">
    <div class="vws_tp">
    <h2>Twelve Teachers<br />12 Monthly Courses<br />Video Instructions<br />Live Teacher Support</h2>
    	<div id="videoBoxId" class="vws_tp_vdos_o">
                        <div class="vws_tp_vdo_sec">
                        <div class="vws_tp_vid_dmo">
                            <h3 style="color:#000;">Watch This Video</h3>
