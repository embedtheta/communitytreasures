...
<html lang="en">
    <head>
		<title>GBE | HEALTH</title>
        <meta charset="utf-8">
		<meta property="og:type" content="website" />
		<meta property="og:url" content="<?php echo $ogUrl; ?>" />
		<meta property="og:title" content="GBE | HEALTH" />
    ...
    <body class="gbe_health">
        ...
        <footer id="foot">
            <div id="wrap">
                <p>Join GBE - Raise Your Income Develop, Your Community & Connect The African Diaspora</p>
            </div>
        </footer>
        <!--footer section end--> 
        <script>
