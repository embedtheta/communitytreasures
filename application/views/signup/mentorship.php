...
<html lang="en">
<head>
<title>GBE | MENTORSHIP</title>
<meta charset="utf-8">
<meta property="og:type" content="website" />
<meta property="og:url" content="<?php echo $ogUrl; ?>" />
<meta property="og:title" content="GBE | MENTORSHIP" />
<meta property="og:image" content="<?php echo base_url();?>css/signup/images/logo.png" />

<!--<link href="<?php echo base_url();?>css/mentorship/style.css" rel="stylesheet" type="text/css">-->
...
<body class="mendorsip">
<div class="bdy_sec">
  <div id="wrap">
                <div class="bdy_lft">
                    <h2>REGENESIS PROGRAM <strong>Mentorship is key</strong></h2>

                </div>
                <div class="bdy_right">

                    <div class="vdo_txt"><h3><strong>Build Your Child's<br>Confidence</strong><strong>Increase Knowledge</strong><strong>Develop their Future</strong></h3></div>
...
<footer id="foot">
<div id="wrap"><p>Join GBE - Create Wealth, Develop Your Community & Connect The African Diaspora</p></div>
</footer>
</body>
</html>