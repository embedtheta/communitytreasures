...
<div class="hdrs">
<div class="wrp">
	<div class="hdr_top"><img src="<?php echo base_url(); ?>images/top_log.jpg" alt=""  /></div>
    <div class="hdr_btm"><h2>Learn Real Estate Agents > Start Now</h2></div>
</div>
</div>
<div class="hdr_btm realst estates">
<div class="wrp">
	<div class="pnk"></div>
    <div class="imr_tp">
    <img src="<?php echo base_url(); ?>images/real_img01.jpg" alt=""  />
    	<img src="<?php echo base_url(); ?>images/real_img02.jpg" alt=""  /></div>
    ...
    <h2>Twelve Teachers<br />12 Monthly Courses<br />Video Instructions<br />Live Teacher Support</h2>
    	<div id="videoBoxId" class="vws_tp_vdos_o">
                        ...
                        <div class="vws_tp_vid_dmo">
                           ...
                           <img class="brds" src="<?php echo base_url(); ?>images/CTRealetate1.jpg" alt=""  />
                            </div>
        </div></div>
...
<div class="hmerk">
<div class="wrp">
<h3>Learn Courses in Real Estate, Property Management, Esthetics, Cosmetology & Make Up - Form The Comfort of Home</h3>
<img src="<?php echo base_url(); ?>images/real_img04.jpg" alt=""  />
</div>
</div>
<footer id="foot">
