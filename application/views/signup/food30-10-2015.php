...
<body>
<div class="hdrs foode">
<div class="wrp">
	<div class="hdr_top"><img src="<?php echo base_url(); ?>images/top_log.png" alt=""  /></div>
    <div class="hdr_btm"><h2>Learn Healthy & Tasty recipes > Start Now</h2></div>
</div>
</div>
<div class="hdr_btm">
<div class="wrp">
	<div class="pnk_cr"></div>
    <div class="imr_tp">
    <img src="<?php echo base_url(); ?>images/food_img2.jpg" alt=""  />
    	<img src="<?php echo base_url(); ?>images/food_img1.jpg" alt=""  /></div>

</div>
</div>
<div class="hdr_mid foot_tst">
<div class="wrp">
    <div class="vws_tp">
    <div id="est_hdn"><h2>Twelve Teachers<br />12 Monthly Courses<br />Video Instructions<br />Live Teacher Support</h2><span id="triangle-right">&nbsp;</span></div>
    	...
    	<div id="videoBoxId" class="vws_tp_vdos_o">
                        ...
                        <div class="vws_tp_vid_dmo">
                            ...
                            <span name="<?php echo $videoPath; ?>" id="video_on_id"><img alt="" src="http://www.communitytreasures.co/css/signup/images/vdo_wtaro.png"></span></div>
                           <img class="brds" src="<?php echo base_url(); ?>images/img03.jpg" alt=""  />
                            </div>
        </div>
        <br class="clear" />
        </div>
...
<div class="pkse" style="background:#f6ece3;">
	<div class="wrp">
...
<div class="hmerk">
<div class="wrp">
<h3>Learn Courses in Aerobic Workout, Yoga, Meditation, Weight Loss & Make Up - Form The Comfort of Home</h3>
<img src="<?php echo base_url(); ?>images/food_img04.jpg" alt=""  />
</div>
</div>
<footer id="foot" style="background:#097d40;">
