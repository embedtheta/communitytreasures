...
.frm_in input[type="email"], #signupfrm input[type="text"], #signupfrm input[type="password"] {
...
<div class="bdy_sec">
  <div id="wrap">
    <div class="bdy_lft">
      ...
      <div class="found_stp_sec">
        <ul>
<li><span>Step 1.</span> <span>Click the button below 'Copy Address'  Go to your wallet,<br> 
              find 'send' bitcoin, paste in our wallet address to buy your 'LIVE' position.</span></li>

<li><span>Step 2.</span> <span>Check your email for verifictation in 30 minutes -1 hrs and collect your<br> 
               login details.</span></li>

<li><span>Step 3.</span> <span>Follow the instructions in the email, click the link and enter your<br>
              live account.</span></li>
</ul>
              
              
              <!--<p>Step 1. Pay with Bitcoin </p>
        <p>Step 2. Check your email in 1hour for Your Login details</p>
        <p>Step 3. Use the details in your email and follow the link to login
          Then your account is active in Live area</p>-->
      </div>
    </div>
    <br class="clear">
    <div class="bdy_right" style="padding-top:0 !important;"> 
      ...
      <div class="signup" style="width:960px !important; min-height: 460px;">
        ...
        <form id="signupfrm" method="post" style="float: left; width: 33%;">
          <div class="frm_in" style=" background: #fff none repeat scroll 0 0; border-radius: 15px; box-shadow: 0 0 12px #aaa;  margin-top: 20px;"> <strong style=" color: #5c5c5c; display: block; font-family: 'Roboto',sans-serif; font-size: 20px; font-weight: 600;  margin: 0;  padding: 9px 0;  text-align: center;    text-transform: uppercase;  width: 100%;">Your Profile Details</strong>
            ...
            <input  style="background:none; padding:0; text-align:center;" readonly type="text" name="surname" id="Surname" value="<?php
                                ...
                                ?>" placeholder="Surname">
            <?php echo form_error('surname', '<span class="error">', '</span>'); ?>
            ...
            <?php echo form_error('cellno', '<span class="error">', '</span>'); ?>
            ...
            <p style="  color: #25369c;  font-size: 16px; font-family:Arial, Helvetica, sans-serif; font-weight: normal; padding: 0;">
              <?php
  ...
  --> 
    ...
    margin-top: 0px;"></iframe>
        <?php 
                        ...
                        echo "<h2 style=\"color: #80007b;font-size: 28px;font-weight: bold;line-height: 64px;font-family: 'Roboto', sans-serif; text-align: center;\">You have already activated your position.</h2> ";
...
<div class="footer-login">
  <div class="wrapper-login">
    ...
    <p class="footer-newlink"><a href="http://www.communitytreasures.co/gateway/contentDetails/earnings-disclaimer">Earnings Disclaimer</a> | <a href="http://www.communitytreasures.co/gateway/contentDetails/privacy-policy">Privacy Policy</a> | <a href="http://www.communitytreasures.co/gateway/contentDetails/terms-and-conditions">Terms &amp; Conditions</a> | <a href="http://www.communitytreasures.co/gateway/contentDetails/compliance">Compliance</a></p>
