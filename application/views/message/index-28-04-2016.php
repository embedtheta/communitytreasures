...
<script>
 ...
 $(document).ready(function(){
	...
	<?php if($totalUserUnderMassUser >= 5){?>//this shoule be 5
...
<div class="wrapper">
	...
	<?php	if($mssPayStatus==0){
		?>
           <li <?php if($userInfo[0]['userLevel'] < 1){?> class="levelClass" <?php }?> id="1"><a href="javascript:void(0)" id="gbeLevel1"><span class="level">Level - 1</span> CT Catalogue<span>Open</span></a></li>
	<?php	}
		else
		{
...
?>
          ...
          <li <?php if($userInfo[0]['userLevel'] < 3){?> class="levelClass" <?php }?> id="3"><a href="<?php if($userInfo[0]['userLevel'] > 2){ echo base_url()."source";}else{?>javascript:void(0)<?php }?>" id="gbeLevel3"><span class="level">Level - 3</span> The Source<span> Open </span></a></li>

          <li <?php if($userInfo[0]['userLevel'] < 4){?> class="levelClass" <?php }?> id="4"><a href="<?php if($userInfo[0]['userLevel'] > 3){ echo base_url()."regeneration";}else{?>javascript:void(0)<?php }?>" id="gbeLevel4"><span class="level">Level - 4</span> Co-operatives <span> Open </span> </a></li>
  ...
  <div class="main_container">
   ...
   <div class="white-bg">
      <div class="mms_page">
      <div class="watch_video_com_trs"><h2>Welcome To <?php echo $userInfo[0]["firstName"];?> <?php echo $userInfo[0]["lastName"];?> V.I.P Suite</h2>
      	<div class="watch_video_com_trs_inr"><a id="videoLinkId04" name="<?php echo $stepWiseVideo[1]["A"]["path"];?>" href="javascript:void(0);">
        <!--Watch this Video-->
        <img src="<?php echo base_url();?>images/CT_Vip2.png"></div>
      </div>
        <!--<div class="mms_page_frm">
          <div class="wch_vdo">
			<a href="javascript:void(0);" name="https://www.youtube.com/embed/tL0UErz8rLA" id="videoLinkId">
                <div class="wtch_vio">
          ...
          <div class="wch_vdo nsfdn">
			...
			<a id="videoLinkId01" name="<?php echo $stepWiseVideo[1]["B"]["path"];?>" href="javascript:void(0);">
                <div class="wtch_vio ">
                    <div class="vdo_img">
                    <img src="http://globalblackenterprises.com/img/wtch.png">
                    <h3>Watch Video</h3></div>
                </div>
            </a>
            <div class="flw_ibst">
            <h3>Level 1 - CT Catalogue</h3>
            <h4>Product & Compensation Plan</h4>
            <p><img src="<?php echo base_url();?>images/mse3.png"></p>
            <!--<p>1) Add 12 People   2) Move Up The Level Two  3) Get Paid</p>-->
            </div>
            <!--<div class="rndud"><h5><strong></strong> </h5><img src="img/trophy.png"></div>-->
            <div class="clear"></div>
          </div>
          <div class="wch_vdo nsfdn">
			<!--<a href="javascript:void(0);" name="https://www.youtube.com/embed/tL0UErz8rLA" id="videoLinkId">--><!--changed 21/8/2015 by RD-->
            <!--<a href="javascript:void(0);" name="https://www.youtube.com/embed/zILF2fLhW_E" id="videoLinkId"> --><!-- Changed by SB on 14/09/2015 -->
			<a id="videoLinkId02" name="<?php echo $stepWiseVideo[1]["C"]["path"];?>" href="javascript:void(0);">
                <div class="wtch_vio ">
                    <div class="vdo_img">
                    <img src="http://globalblackenterprises.com/img/wtch.png">
                    <h3>Watch Video</h3></div>
            ...
            <div class="flw_ibst">
                       <h3>Level 2 - 5 Large Pay Outs</h3>
            <h4>Product & Compensation Plan</h4>
           <p><img src="<?php echo base_url();?>images/mse3.png"></p>
            <!--<p>1) Add 12 People   2) Move Up The Level Two  3) Get Paid</p>-->
            </div>
          ...
          <div class="wch_vdo nsfdn">
			<!--<a href="javascript:void(0);" name="https://www.youtube.com/embed/tL0UErz8rLA" id="videoLinkId">--><!--changed 21/8/2015 by RD-->
            <!--<a href="javascript:void(0);" name="https://www.youtube.com/embed/zILF2fLhW_E" id="videoLinkId"> --><!-- Changed by SB on 14/09/2015 -->
			<a id="videoLinkId03" name="<?php echo $stepWiseVideo[1]["D"]["path"];?>" href="javascript:void(0);">
                <div class="wtch_vio ">
                    <div class="vdo_img">
                    <img src="http://globalblackenterprises.com/img/wtch.png">
                    <h3>Watch Video</h3></div>
