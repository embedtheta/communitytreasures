        ...
        <div id="cssmenu">
          <ul>
			<?php if($category_details){
			   ...
			   ?>
				<li><a href="<?php echo base_url();?>dashboard/ct_music_product/<?php echo $cd['id'];?>"><?php echo $cd['title'];?></a></li>
			 <?php } }?>
		</ul>
        </div>
      </div>
		 ...
		 <?php } }?>
             ...
             <div class="new_sec_added">
                ...
                <div class="src_catgr scroll-sec">
                	<ul>
                	 <!--li><a href="<?php echo base_url();?>dashboard/music_buy"><img src="<?php echo base_url();?>/CT_images/Music.jpeg">
