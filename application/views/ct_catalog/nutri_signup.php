...
<div class="hdrs monzi">
  <div class="wrp">
    ...
    <h1>Web-Tools For Sellers of Nutrition & Weight Management Products</h1>
...
<div class="hdr_mid">
  <div class="wrp"><!--wrp_o-->
    <div class="vws_tp">
      <div id="est_hdn"><img src="<?php echo base_url();?>CT_images/blu-tw3.png" alt="">
...
<div class="pkse">
  <div class="wrp">
    ...
    <form id="frms_signup" action="<?php echo base_url();?>signup/Nutri/<?php echo $ct_userID; ?>" method="post" enctype="multipart/form-data">
	...
	<?php }?>
      <div class="sing">
	  <!--input name="City" id="City" placeholder="Select city" type="text"-->
    ...
    <br class="clear">
	<a class="foradmin" href="<?php echo base_url();?>dashboard/ctadminnutri">for amdin</a>
  </div>
</div>
<div class="hmerk">
  <div class="wrp">
