...
<?php 						 
      ...
      <div class="new_sec_added">
                        ...
                        <div class="src_catgr scroll-sec">
                          ...
                          <h3><a href="<?php echo base_url();?>dashboard/offer_detail/<?php echo $CT_offer_list[0]['offer_id']; ?>">
                          <?php echo $CT_offer_list[0]['offer_name']; ?></a></h3><img src="<?php echo $this->config->item('gbe_base_url').'useruploads/'.$CT_offer_list[0]['image'];?>" width="105" height="105">
                          <div class="tvclass">               <!--<a id="contload" href="http://www.afrowebb.com/welcome/viewChannel_Detail/1">-->
                          <a href="<?php echo base_url();?>dashboard/offer_detail/<?php echo $CT_offer_list[0]['offer_id']; ?>">
                          <?php echo $CT_offer_list[0]['description']; ?></a>
