        ...
        <div class="my_top_sec">
            ...
            <img alt="" src="<?php echo $this->config->item('gbe_base_url');?>/useruploads/<?php echo $monetizerDetail[0]['profile'];?>">
                ...
                <h2><?php echo $monetizerDetail[0]['firstName']." ".$monetizerDetail[0]['lastName']; ?></h2>
                    ...
                    <div class="cntct_dtl"><a href="<?php echo $monetizerDetail[0]['webUrl'];?>" target="_blank"><?php echo $monetizerDetail[0]['webUrl'];?></a>
                    <a href="<?php echo $monetizerDetail[0]['emailID'];?>"><?php echo $monetizerDetail[0]['emailID'];?></a>
                    <span class="cle"><?php echo $monetizerDetail[0]['phone'];?></span></div>
                    <div class="shres">
                    	<!--<a href="#">Share</a>-->
...
<span class='st_pinterest_hcount' displayText='Pinterest'></span>-->
		...
		<?php if($bannerDetail!=""){?>
		<img src="<?php echo $this->config->item('gbe_base_url');?>CT_sponcer_img/<?php echo $bannerDetail; ?>" alt="">
		<?php }else{
			?>
