    ...
    <div class="bdysec_left">
	  ...
	  <?php if($event){
              ...
              <div class="list-detail">
                <!-- Image -->
                <img width="180" height="200" class="article-left-img" src="<?php echo $this->config->item('gbe_base_url');?>adminuploads/productPagesImg/<?php echo $ev['image'];?>">
                
                <!-- body -->
                <h1><?php echo $ev['title'];?></h1>
      ...
      <!--div class="new_sec_added">
                        ...
                        <div class="src_catgr scroll-sec">
                            <ul>
                            <li><a href="<?php echo base_url();?>dashboard/BeautyMonetizer_buy"><img src="<?php echo base_url();?>/CT_images/Music.jpeg">
                            ...
                            ?>
                            <li><a href="#"><img src="<?php echo $this->config->item('gbe_base_url').'useruploads/'.$mu['profile'];?>">
                                <p>A.B.Y.S.S</p>
                            </a></li>                                    
                                <?php } } ?>
           ...
           <img class="fmpi palvidd" src="<?php echo base_url();?>/images/no_image.jpg">
            ...
            <div class="fashn_rit event"><h2>Events &amp; Celebrations</h2>
            			 <?php if($monetizer_event){
                            ...
                            ?>
							<a href="http://www.afrowebb.com/welcome/view_Detail/17">
