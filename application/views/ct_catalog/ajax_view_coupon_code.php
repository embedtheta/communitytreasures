...
.big_fot{font-size: 20px; line-height: 24px; margin-bottom: 15px;}
  ...
  <div class="row" style="background: #fcff00;margin-top: 10px;">
    <div class="span12">
      <div class="thumbnail center well well-small text-center">
       ...
       <!-- <p id="voucher">Your Voucher is <span id="voucherCode"></span></p>-->
        <p style="font-size: 25px; color: #000; margin-bottom: 26px;">Print / Download Your Voucher.</p>
		<p> <input style="width: 200px; height: 50px; font-size: 17px; margin-bottom: 25px;" type="button" name="btnprint" id="myprint" value="Print / Download" onclick="PrintMe('divid')"/><!-- <button onclick="myFunction()" id="myprint">Print</button> --> </p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          <div class="thumbnail center well well-small text-center">
            <h2>GET VOUCHER</h2>
            <p class="big_fot">Enter your email address and we will send this offer to you.</p>
            <div class="sub_mit">
              ...
              <input type="button" value="SUBMIT" class="btn btn-large" id="btn2" style="display: block; margin: 0 auto; margin-top: 15px;
...
font-size: 18px;">Take an extra</span></div>
    ...
    font-size: 17px;">For Product FlipFlopBinaray on <br />
				<strong>communitytreasures.co</strong></p></td>
				  ...
				  <tr>
				  <td align="center" style="text-align: center;">Copyright @ communitytreasures.co 2017</td>
				  </tr>
				</table>
