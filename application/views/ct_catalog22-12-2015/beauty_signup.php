...
<div class="hdrs monzi">
  <div class="wrp">
    <h1>For Agents Who Sell Cosmetics & Beauty Products</h1>
    </div>
</div>
<div class="hdr_btm">
  <div class="wrp">
...
<div class="hdr_mid">
  <div class="wrp"><!--wrp_o-->
    <div class="vws_tp">
      <div id="est_hdn"><img src="<?php echo base_url();?>CT_images/blu-tw4.png" alt=""></div>
...
<div class="pkse">
  <div class="wrp">
    ...
    <form id="frms_signup" action="<?php echo base_url();?>dashboard/BeautyMonetizer" method="post" enctype="multipart/form-data">
