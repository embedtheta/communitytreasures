...
<div class="hdrs monzi">
  <div class="wrp">
    <h1>Creat Your Account, Market Your Image, Grow Your Fan-Base & Monetize Your Followers</h1>
 </div>
</div>
<div class="hdr_btm">
  <div class="wrp">
    <div class="imr_tp"> <img src="<?php echo base_url();?>CT_images/bdas.jpg" alt=""> </div>
  </div>
</div>
<div class="hdr_mid">
  <div class="wrp"><!--wrp_o-->
    <div class="vws_tp">
      <div id="est_hdn"><img src="<?php echo base_url();?>CT_images/blu-tw1.png" alt=""></div>
...
<div class="pkse">
  <div class="wrp">
    ...
    <form id="frms_signup" action="<?php echo base_url();?>dashboard/ModelsMonetizer" method="post" enctype="multipart/form-data">
