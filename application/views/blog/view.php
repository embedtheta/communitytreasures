    ...
    <div class="hd_sec"> 
      <div class="hd_sec_in">
        ...
        <div class="headerrightform">
          <h2><span>Join My Community Treasures</span> To Make Money Online</h2>
        ...
        <div class="blog_page">
          <div class="blg_dv">
            ...
            <div class="authr">
             ...
             <?php if($blogDetails[0]->post_image != ''){?> 
            <div class="blog_inner_page_image"><img src="<?php echo base_url();?>useruploads/blogs/others/<?php echo $blogDetails[0]->post_image;?>" alt=""></div> 
            <?php }?>
