			...
			$this->_message ='<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:Verdana, Geneva, sans-serif; color:#5c5c5c; font-size:14px; line-height:18px; padding: 15px; border: 15px solid #cfcfcf;">
								<tr>
								  ...
								  <tr>
								   ...
								   <h2 style="  color: #1b75bc; font-size: 25px; line-height: 26px;"> I would like you <br>
								to pay your Subscription via Bitcoin <br>& Join Communitytreasure as a live user.</h2>
								...
								<tr>
								  ...
								  <tr>
									<td align="center" valign="top">
										<img src="'.base_url().'images/logo.png" width="150" height="150" alt="" />									
								   <h2 style="  color: #1b75bc; font-size: 25px; line-height: 26px;"> I would like you <br>
								to pay your Subscription via Bitcoin <br>& Join Communitytreasure as a live user. '.$userTypename.'.</h2>
								  ...
								  <tr>
								   ...
								   <p> Hi  '.$userName.', </p>
								<p>   
								Please note your login credential</p>
								 ...
								 <br />
								  ...
								  <a href="'.$resendEmail_url.'signup/'.$signUpLink.'" target="_blank" style="background: #1bb58f none repeat scroll 0 0; border-radius: 5px; clear: both; color: #fff; font-size: 16px; margin: 10px 0;
									padding: 10px; text-decoration: none;">Click Here To Enter Your Account</a>
									<br /><br /><br />
									</td>
								  </tr>
