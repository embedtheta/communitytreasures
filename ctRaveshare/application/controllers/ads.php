...
class Ads extends CI_Controller {
    ...
    public function index() {
		...
		$tempList_music = $this->common_model->fetchTopAds_visited_music(1, $page, $this->session->userdata('userId'), 34);
		$viewData["list_music"] = $tempList_music;
		
		$tempList_events = $this->common_model->fetchTopAds_visited_events(1, $page, $this->session->userdata('userId'), 59);
