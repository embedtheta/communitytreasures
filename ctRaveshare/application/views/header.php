...
if(formSubmitMsg !=""){
	$.fancybox.open(formSubmitMsg);
		 if(formSubmitType == "tech_support")
		{
			$('#serviceList_2').click();
		}
        ...
        <div class="top"> 
            ...
            <div class="logo fltleft">
                <?php if(isset($this->session->userdata['userId'])){ ?>
                 <a href="<?php echo base_url().'myaccount/';?>"><img src="<?php echo base_url(); ?>images/logo-login2.png" alt="CommunityTreasures"></a>
                 <?php } else{?>
                 <a href="<?php echo base_url().'myaccount';?>"><img src="<?php echo base_url(); ?>images/logo.png" alt="CommunityTreasures"></a>
                 <?php } ?>
            </div>
            <!-- logo end -->
           <?php 
			...
			<?php if(isset($this->session->userdata['userId'])){ ?>
             ...
             <!--9/9/2015 close by ujjwal sana-->
				...
				<span><a href="<?php echo base_url(); ?>gateway/logout" style="color:#1b75bc;">Log Out</a></span>
			 </div>
			<?php }?>
            <!-- log form end -->
            <div class="clear"></div>
