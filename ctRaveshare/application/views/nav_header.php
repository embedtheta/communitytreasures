...
<h1 style="position: relative;top: -44px;text-align: center;"><?php if($this->uri->segment(1)=='ads') {?><a href="<?php echo base_url();?>myaccount" class="backkktohome">< Back To Home Page</a><?php } ?>  FREE SIMULATION AREA</h1>
