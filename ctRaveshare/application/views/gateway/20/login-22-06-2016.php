...
<div class="top-login_top" id="header">
  <div class="wrapper-login">
    ...
    <p class="login-righttop"> <span><a href="javascript:void(0)" class="login-manu">Login</a></span></p>
    <br class="clr" />
  ...
  <div class="header-login">
    <div class="wrapper-login">
      ...
      <div class="com-logn-bannerright">
        <!--<img src="<?php //echo base_url(); ?>images/com-down-arrow.png" width="29" height="24" alt="" class="down-arrow"/>-->
