...
<meta property="og:image" content="<?php echo base_url();?>images/logo-fb.jpg" />
...
$(document).ready(function() {
    ...
    <?php if ($msg!="" && $msgType == 1) { ?>
		...
		$.fancybox.open('<div class="ppup_level" style="padding-top:10px;"><div class="ppup_inr"><div id="levelup_alert" class="switch mov_up"><a href="javascript:;" class="close_btn_level" title="Close"></a><h2 style="font:normal 42px/40px Arial, Helvetica, sans-serif; color:#07237d; text-transform:none;"><br>You Have Successfully <br>Completed Step 1<br></h2><p class="simplebuildgry" style="font:normal 42px/40px Arial, Helvetica, sans-serif; color:#a511f0;"><br>Please Re-check Your<br>Email Again in 20Minutes<br>We Will Send You<br>Your Access Email<br /></p><br /><h2 style="font:normal 38px/40px Arial, Helvetica, sans-serif; color:#07237d; text-transform:none;">Thank you</h2></div><br class="clear" /></div></div>');
...
if($afrooPaymentStatus){
    echo '<div>';
    echo "<h1>Account is already activated.You may login in your account by using the credential sended to your register mailbox.</h1>";
}
else{
