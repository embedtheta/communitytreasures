...
<div class="top-login_top" id="header">
  ...
  <div class="wrapper-login">
    ...
    <p class="login-righttop"> <span><a href="javascript:void(0)" class="login-manu" style="background: #ea1063 none repeat scroll 0 0; border-radius: 5px; color: #fff; display: block; float: right; font-size: 22px; line-height: 40px; text-align: center; width: 180px; margin-top: 15px;">Login</a></span></p>

    <br class="clr" />

    <div class="login-manu-sub" style="display:<?php echo $styleStatus;?>; right:120px;">
      ...
      <div class="login-drop">
        ...
        <form action="<?php echo base_url();?>gateway/loginRave" method="post" id="frnd" class="login-form">
...
<div class="top-login">
  ...
  <div class="header-login">
    ...
    <div class="wrapper-login"> 
      ...
      <div class="com-logn-bannerleft" style="float:left;" ><img src="<?php echo base_url(); ?>images/left-image-header.png" width="432" height="432" alt="" />
      
      </div>
<div style="float:right; margin-top: 150px;" ><img src="<?php echo base_url(); ?>images/home-bitcoin-button1.png" width="" height="" alt=""  />
</div>
      <!--<div class="com-logn-bannerright">

        <form id="signupForm" action="<?php echo base_url();?>gateway/signUpRave" method="post">

          <input name="signUpEmail" type="text" id="signUpEmailId" value="" placeholder="Enter VALID Email Here..." />

		  <select name="activeFounder" >
          ...
          <input name="submit" id="submitId" type="submit" value="Get Access Now!" />
