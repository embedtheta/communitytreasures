...
class PayPal_IPN {
    ...
    function ipn_response($request) {
		...
		mail("cogito.sunav@gmail.com","payment Details in USD",$message, implode("\r\n", $headers));
		$payment_details = serialize($_POST);
		mysql_query("INSERT INTO payment_transac (item_name,item_number,payment_details) VALUES ('$item_name','$item_number','$payment_details')");
        mysql_close($con);
