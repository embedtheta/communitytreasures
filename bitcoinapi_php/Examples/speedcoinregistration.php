<?php	
	...
	// For example, for accept payments in bitcoins, speedcoins use - $available_payments = array('bitcoin', 'speedcoin'); 
	$available_payments = array('bitcoin', 'speedcoin');
	...
	$all_keys = array(	
		...
		"speedcoin" => array("public_key" => "7534AA9iqPzSpeedcoin77SPDPUBgSos9BgfhcUeaeEBak0nO2
", "private_key" => "7534AA9iqPzSpeedcoin77SPDPRVzP7SpVHvUvS7M0qvosCjgq")
	); 
