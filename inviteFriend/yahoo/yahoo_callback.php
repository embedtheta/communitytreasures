...
<body class="invted">
    ...
    <div class=" hm_lggn">
            ...
            <form action="http://globalblackenterprises.com/dashboard/getYahooContacts" method="post" name="gmail">
<?php
...
$count = 0;
foreach ($retarrs['email'] as $title) {
	$count++;

?>	
	<li><strong><?php echo $count;?>.</strong><input type="checkbox" class="emailsClass" name="emails[]" value="<?php echo $title ;?>">
	<p><?php echo $title ;?></p></li>
<?php 
