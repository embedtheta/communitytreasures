...
define('OAUTH_CONSUMER_KEY', 'dj0yJmk9cUVVQmpNNkExR0I2JmQ9WVdrOVFsRk5jRGx1TlRnbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1mMg--');
define('OAUTH_CONSUMER_SECRET', '95439f25141bef33857e2d73e4ad8bc6cf70d512');
 ...
 function callcontact_yahoo($consumer_key, $consumer_secret, $guid, $access_token, $access_token_secret, $usePost=false, $passOAuthInHeader=true)
{
  ...
  // extract successful response
          ...
          //print(json_pretty_print($body));
            ...
            foreach($yahoo_array as $key=>$values){
                foreach($values->contact as $keys=>$values_sub){
                    ...
                    if(isset($values_sub->fields[1]->value)){
                        $email = $values_sub->fields[1]->value;
                    }elseif(isset($values_sub->fields[0]->value)){
    ...
    $newList['total'] = count($newList['email']); 
    return $newList;
}
